  ...
  "tag": "v0.12.0"
    ...
    <tr>
      <td id="sygnal--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L891">sygnal.podSecurityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="externalPostgresql">
        <div style="max-width: 150px;"><a href="../values.yaml#L1118">externalPostgresql</a></div>
      </td>
      <td>map</td>
  ...
  "username": "synapse"
    ...
    <tr>
      <td id="externalPostgresql--database">
        <div style="max-width: 150px;"><a href="../values.yaml#L1122">externalPostgresql.database</a></div>
      </td>
      <td>string</td>
...
"synapse_db"
    ...
    <tr>
      <td id="externalPostgresql--username">
        <div style="max-width: 150px;"><a href="../values.yaml#L1125">externalPostgresql.username</a></div>
      </td>
      <td>string</td>
      <td>Name für PostgreSQL Nutzer</td>
      <td>
...
"synapse"
    ...
    <tr>
      <td id="externalPostgresql--password">
        <div style="max-width: 150px;"><a href="../values.yaml#L1128">externalPostgresql.password</a></div>
      </td>
      <td>string</td>
      <td>Passwort für PostgreSQL Nutzer</td>
      <td>
...
"synapse"
    ...
    <tr>
      <td id="externalPostgresql--existingSecret">
        <div style="max-width: 150px;"><a href="../values.yaml#L1131">externalPostgresql.existingSecret</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="externalPostgresql--existingSecretPasswordKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L1134">externalPostgresql.existingSecretPasswordKey</a></div>
      </td>
      <td>string</td>
...
"password"
    ...
    <tr>
      <td id="externalPostgresql--extraArgs">
        <div style="max-width: 150px;"><a href="../values.yaml#L1140">externalPostgresql.extraArgs</a></div>
      </td>
      <td>list</td>
      <td>Zusätzliche Argumente für die Datenbankverbindung ref: https://github.com/matrix-org/synapse/blob/develop/docs/postgres.md#synapse-config</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="redis--image--registry">
        <div style="max-width: 150px;"><a href="../values.yaml#L1152">redis.image.registry</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"registry.opencode.de"
    ...
    <tr>
      <td id="redis--image--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L1153">redis.image.repository</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"bwi/bundesmessenger/backend/container-images/jammy-redis-production"
    ...
    <tr>
      <td id="redis--image--tag">
        <div style="max-width: 150px;"><a href="../values.yaml#L1154">redis.image.tag</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"v6.0.16"
    ...
    <tr>
      <td id="redis--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1159">redis.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="redis--auth">
        <div style="max-width: 150px;"><a href="../values.yaml#L1163">redis.auth</a></div>
      </td>
      <td>map</td>
  ...
  "password": "synapse"
    ...
    <tr>
      <td id="redis--architecture">
        <div style="max-width: 150px;"><a href="../values.yaml#L1170">redis.architecture</a></div>
      </td>
      <td>string</td>
...
"standalone"
    ...
    <tr>
      <td id="redis--master--kind">
        <div style="max-width: 150px;"><a href="../values.yaml#L1172">redis.master.kind</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"StatefulSet"
    ...
    <tr>
      <td id="redis--master--persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1177">redis.master.persistence.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="redis--master--service--ports--redis">
        <div style="max-width: 150px;"><a href="../values.yaml#L1181">redis.master.service.ports.redis</a></div>
      </td>
      <td>int</td>
      <td>Serviceport</td>
      <td>
...
6379
    ...
    <tr>
      <td id="externalRedis">
        <div style="max-width: 150px;"><a href="../values.yaml#L1190">externalRedis</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="ingress--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1209">ingress.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--traefikPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1213">ingress.traefikPaths</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/use-regex"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1219">ingress.annotations."nginx.ingress.kubernetes.io/use-regex"</a></div>
      </td>
      <td>bool</td>
...
"true"
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/proxy-body-size"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1221">ingress.annotations."nginx.ingress.kubernetes.io/proxy-body-size"</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/enable-owasp-core-rules"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1222">ingress.annotations."nginx.ingress.kubernetes.io/enable-owasp-core-rules"</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"true"
    ...
    <tr>
      <td id="ingress--csHosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1231">ingress.csHosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--hosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1238">ingress.hosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--wkHosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1245">ingress.wkHosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1262">ingress.paths</a></div>
      </td>
      <td>path</td>
...
[]
    ...
    <tr>
      <td id="ingress--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1279">ingress.csPaths</a></div>
      </td>
      <td>path</td>
...
[]
    ...
    <tr>
      <td id="ingress--includeUnderscoreSynapse">
        <div style="max-width: 150px;"><a href="../values.yaml#L1282">ingress.includeUnderscoreSynapse</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--includeServerName">
        <div style="max-width: 150px;"><a href="../values.yaml#L1286">ingress.includeServerName</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--tls">
        <div style="max-width: 150px;"><a href="../values.yaml#L1298">ingress.tls</a></div>
      </td>
      <td>map</td>
...
[]
    ...
    <tr>
      <td id="ingress--className">
        <div style="max-width: 150px;"><a href="../values.yaml#L1303">ingress.className</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="contentscanner--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1311">contentscanner.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="contentscanner--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1313">contentscanner.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v1.0.3"
    ...
    <tr>
      <td id="contentscanner--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L1318">contentscanner.replicaCount</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
1
    ...
    <tr>
      <td id="contentscanner--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1322">contentscanner.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="contentscanner--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1324">contentscanner.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"1Gi"
    ...
    <tr>
      <td id="contentscanner--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1327">contentscanner.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="contentscanner--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1329">contentscanner.resources.requests.memory</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="schadcodescanner--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1337">schadcodescanner.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="schadcodescanner--imageclamav">
        <div style="max-width: 150px;"><a href="../values.yaml#L1339">schadcodescanner.imageclamav</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v0.103.6"
    ...
    <tr>
      <td id="schadcodescanner--imagecicap">
        <div style="max-width: 150px;"><a href="../values.yaml#L1344">schadcodescanner.imagecicap</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v0.5.6"
    ...
    <tr>
      <td id="schadcodescanner--persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1351">schadcodescanner.persistence.enabled</a></div>
      </td>
      <td>bool</td>
      <td></td>
      <td>
...
true
    ...
    <tr>
      <td id="schadcodescanner--persistence--existingClaim">
        <div style="max-width: 150px;"><a href="../values.yaml#L1354">schadcodescanner.persistence.existingClaim</a></div>
      </td>
      <td>string</td>
      <td>Name des VolumeClaims</td>
      <td>
...
leer, damit dynamische Volumes genutzt werden können (dennoch persistent)
    ...
    <tr>
      <td id="schadcodescanner--persistence--storageClass">
        <div style="max-width: 150px;"><a href="../values.yaml#L1356">schadcodescanner.persistence.storageClass</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="schadcodescanner--persistence--accessMode">
        <div style="max-width: 150px;"><a href="../values.yaml#L1358">schadcodescanner.persistence.accessMode</a></div>
      </td>
      <td>string</td>
...
"ReadWriteOnce"
    ...
    <tr>
      <td id="schadcodescanner--persistence--size">
        <div style="max-width: 150px;"><a href="../values.yaml#L1360">schadcodescanner.persistence.size</a></div>
      </td>
      <td>string</td>
      <td>Größe des zu nutzenden Volumes</td>
      <td>
...
"10Gi"
    ...
    <tr>
      <td id="schadcodescanner--extraEnv">
        <div style="max-width: 150px;"><a href="../values.yaml#L1370">schadcodescanner.extraEnv</a></div>
      </td>
      <td>map</td>
...
[]
    ...
    <tr>
      <td id="schadcodescanner--service--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1375">schadcodescanner.service.port</a></div>
      </td>
      <td>int</td>
...
1344
    ...
    <tr>
      <td id="schadcodescanner--freshclam--mirrors">
        <div style="max-width: 150px;"><a href="../values.yaml#L1379">schadcodescanner.freshclam.mirrors</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"database.clamav.net"
    ...
    <tr>
      <td id="schadcodescanner--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L1384">schadcodescanner.replicaCount</a></div>
      </td>
      <td>int</td>
      <td>Anzahl der Worker-Container Hinweis: Wenn autoscaling.enabled=true und replicaCount geringer als autoscaling.minReplicas oder wenn nicht gesetzt, dann wird autoscaling.minReplicas übernommen</td>
      <td>
...
1
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1391">schadcodescanner.autoscaling.enabled</a></div>
      </td>
      <td>bool</td>
      <td>schalte das HPA für die Container ein Hinweis: Kann für alle spezifischen Worker benutzt werden Dazu muss entsprechende Konfiguration in die separaten Sektionen eingefügt werden</td>
      <td>
...
false
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--minReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L1393">schadcodescanner.autoscaling.minReplicas</a></div>
      </td>
      <td>int</td>
      <td>minimale Anzahl der Worker-Container</td>
      <td>
...
1
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--maxReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L1395">schadcodescanner.autoscaling.maxReplicas</a></div>
      </td>
      <td>int</td>
      <td>maximale Anzahl der Worker-Container</td>
      <td>
...
4
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--targetCPUUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L1397">schadcodescanner.autoscaling.targetCPUUtilizationPercentage</a></div>
      </td>
      <td>int</td>
      <td>Prozentsatz für CPU-Auslastung um Scaling zu triggern</td>
      <td>
...
90
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--targetMemoryUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L1399">schadcodescanner.autoscaling.targetMemoryUtilizationPercentage</a></div>
      </td>
      <td>int</td>
      <td>Prozentsatz für RAM-Auslastung um Scaling zu triggern</td>
      <td>
...
80
    ...
    <tr>
      <td id="schadcodescanner--limits--fileSize">
        <div style="max-width: 150px;"><a href="../values.yaml#L1403">schadcodescanner.limits.fileSize</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
50
    ...
    <tr>
      <td id="schadcodescanner--limits--scanSize">
        <div style="max-width: 150px;"><a href="../values.yaml#L1405">schadcodescanner.limits.scanSize</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
100
    ...
    <tr>
      <td id="schadcodescanner--limits--connectionQueueLength">
        <div style="max-width: 150px;"><a href="../values.yaml#L1407">schadcodescanner.limits.connectionQueueLength</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
100
    ...
    <tr>
      <td id="schadcodescanner--limits--maxThreads">
        <div style="max-width: 150px;"><a href="../values.yaml#L1409">schadcodescanner.limits.maxThreads</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
4
    ...
    <tr>
      <td id="schadcodescanner--limits--sendBufTimeout">
        <div style="max-width: 150px;"><a href="../values.yaml#L1411">schadcodescanner.limits.sendBufTimeout</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
500
    ...
    <tr>
      <td id="schadcodescanner--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1416">schadcodescanner.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"1500m"
    ...
    <tr>
      <td id="schadcodescanner--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1418">schadcodescanner.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"4Gi"
    ...
    <tr>
      <td id="schadcodescanner--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1421">schadcodescanner.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="schadcodescanner--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1423">schadcodescanner.resources.requests.memory</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="coturn--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1437">coturn.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="coturn--turnUris">
        <div style="max-width: 150px;"><a href="../values.yaml#L1440">coturn.turnUris</a></div>
      </td>
      <td>map</td>
  ...
  "udp": 3478
    ...
    <tr>
      <td id="coturn--existingcoturn--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1446">coturn.existingcoturn.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="coturn--default_ns">
        <div style="max-width: 150px;"><a href="../values.yaml#L1448">coturn.default_ns</a></div>
      </td>
      <td>string</td>
...
"default"
    ...
    <tr>
      <td id="coturn--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1450">coturn.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "Hier das Tag für das Image des Coturn eintragen - NICHT EMPFOHLEN!"
    ...
    <tr>
      <td id="coturn--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1455">coturn.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="synapse_admin--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1468">synapse_admin.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="synapse_admin--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L1470">synapse_admin.uri</a></div>
      </td>
      <td>string</td>
...
null
    ...
    <tr>
      <td id="synapse_admin--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1472">synapse_admin.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v0.8.5"
    ...
    <tr>
      <td id="synapse_admin--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1481">synapse_admin.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="synapse_admin--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1483">synapse_admin.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"15Mi"
    ...
    <tr>
      <td id="synapse_admin--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1486">synapse_admin.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="synapse_admin--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1488">synapse_admin.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="synapse_admin--podSecurityContext--sysctls">
        <div style="max-width: 150px;"><a href="../values.yaml#L1495">synapse_admin.podSecurityContext.sysctls</a></div>
      </td>
      <td>map</td>
...
[
  {
    ...
    <tr>
      <td id="synapse_admin--podSecurityContext--runAsGroup">
        <div style="max-width: 150px;"><a href="../values.yaml#L1498">synapse_admin.podSecurityContext.runAsGroup</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
1001
    ...
    <tr>
      <td id="synapse_admin--podSecurityContext--runAsUser">
        <div style="max-width: 150px;"><a href="../values.yaml#L1499">synapse_admin.podSecurityContext.runAsUser</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
1001
    ...
    <tr>
      <td id="synapse_admin--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1505">synapse_admin.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsNonRoot": true
    ...
    <tr>
      <td id="synapse_admin--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L1537">synapse_admin.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Pfad des Healthchecks</td>
      <td>
...
"/status"
    ...
    <tr>
      <td id="synapse_admin--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1539">synapse_admin.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Port des Healthchecks</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="webclient--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1548">webclient.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="webclient--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L1550">webclient.uri</a></div>
      </td>
      <td>string</td>
...
null
    ...
    <tr>
      <td id="webclient--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1552">webclient.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v2.1.0"
    ...
    <tr>
      <td id="webclient--annotations--"nginx--ingress--kubernetes--io/configuration-snippet"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1557">webclient.annotations."nginx.ingress.kubernetes.io/configuration-snippet"</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"add_header X-Frame-Options SAMEORIGIN;\nadd_header X-Content-Type-Options nosniff;\nadd_header X-XSS-Protection \"1; mode=block\";\nadd_header Content-Security-Policy \"frame-ancestors 'none'\";\n"
    ...
    <tr>
      <td id="webclient--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1566">webclient.podSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="webclient--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1575">webclient.securityContext</a></div>
      </td>
      <td>map</td>
      <td>Konfiguration für die Container-Sicherheitsrichtlinie weitere Möglichkeiten:  capabilities:    drop:    - ALL</td>
      <td>
