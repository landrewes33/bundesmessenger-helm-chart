...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--media_repository--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L787">workers.media_repository.paths</a></div>
      </td>
      <td>list</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--media_repository--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L792">workers.media_repository.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"2000m"
    ...
    <tr>
      <td id="workers--media_repository--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L794">workers.media_repository.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"3500Mi"
    ...
    <tr>
      <td id="workers--media_repository--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L797">workers.media_repository.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"1000m"
    ...
    <tr>
      <td id="workers--media_repository--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L799">workers.media_repository.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"2500Mi"
    ...
    <tr>
      <td id="workers--user_dir--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L807">workers.user_dir.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--user_dir--name">
        <div style="max-width: 150px;"><a href="../values.yaml#L809">workers.user_dir.name</a></div>
      </td>
      <td>string</td>
...
"user_directory_worker"
    ...
    <tr>
      <td id="workers--user_dir--generic">
        <div style="max-width: 150px;"><a href="../values.yaml#L811">workers.user_dir.generic</a></div>
      </td>
      <td>bool</td>
      <td>Wird aus dem generischen Worker abgeleitet</td>
      <td>
...
true
    ...
    <tr>
      <td id="workers--user_dir--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L813">workers.user_dir.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "client"
    ...
    <tr>
      <td id="workers--user_dir--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L816">workers.user_dir.csPaths</a></div>
      </td>
      <td>list</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L824">persistence.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="persistence--existingClaim">
        <div style="max-width: 150px;"><a href="../values.yaml#L827">persistence.existingClaim</a></div>
      </td>
      <td>string</td>
...
leerer Wert lässt dynamisches Provisionieren zu
    ...
    <tr>
      <td id="persistence--storageClass">
        <div style="max-width: 150px;"><a href="../values.yaml#L829">persistence.storageClass</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="persistence--accessMode">
        <div style="max-width: 150px;"><a href="../values.yaml#L831">persistence.accessMode</a></div>
      </td>
      <td>string</td>
      <td>Zugriffsmodus</td>
      <td>
...
"ReadWriteOnce"
    ...
    <tr>
      <td id="persistence--size">
        <div style="max-width: 150px;"><a href="../values.yaml#L833">persistence.size</a></div>
      </td>
      <td>string</td>
...
"10Gi"
    ...
    <tr>
      <td id="volumePermissions--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L839">volumePermissions.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="volumePermissions--uid">
        <div style="max-width: 150px;"><a href="../values.yaml#L842">volumePermissions.uid</a></div>
      </td>
      <td>int</td>
...
2666
    ...
    <tr>
      <td id="volumePermissions--gid">
        <div style="max-width: 150px;"><a href="../values.yaml#L845">volumePermissions.gid</a></div>
      </td>
      <td>int</td>
      <td>Nutzer-ID Notwendig für policy 'require-uid-greater-2000'</td>
      <td>
...
2666
    ...
    <tr>
      <td id="volumePermissions--image--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L849">volumePermissions.image.repository</a></div>
      </td>
      <td>string</td>
...
"registry.opencode.de/bwi/bundesmessenger/backend/container-images/jammy-base-production"
    ...
    <tr>
      <td id="volumePermissions--image--tag">
        <div style="max-width: 150px;"><a href="../values.yaml#L852">volumePermissions.image.tag</a></div>
      </td>
      <td>string</td>
...
"b7"
    ...
    <tr>
      <td id="volumePermissions--image--pullPolicy">
        <div style="max-width: 150px;"><a href="../values.yaml#L854">volumePermissions.image.pullPolicy</a></div>
      </td>
      <td>string</td>
...
"IfNotPresent"
    ...
    <tr>
      <td id="volumePermissions--resources">
        <div style="max-width: 150px;"><a href="../values.yaml#L863">volumePermissions.resources</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="service--type">
        <div style="max-width: 150px;"><a href="../values.yaml#L871">service.type</a></div>
      </td>
      <td>string</td>
...
"ClusterIP"
    ...
    <tr>
      <td id="service--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L873">service.port</a></div>
      </td>
      <td>int</td>
...
8008
    ...
    <tr>
      <td id="service--targetPort">
        <div style="max-width: 150px;"><a href="../values.yaml#L875">service.targetPort</a></div>
      </td>
      <td>int</td>
  ...
  <tbody>
    <tr>
      <td id="sygnal--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L884">sygnal.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="sygnal--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L886">sygnal.image</a></div>
      </td>
      <td>maps</td>
  ...
  "tag": "v0.12.0"
    ...
    <tr>
      <td id="sygnal--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L901">sygnal.podSecurityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="sygnal--proxy">
        <div style="max-width: 150px;"><a href="../values.yaml#L903">sygnal.proxy</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="sygnal--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L912">sygnal.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "readOnlyRootFilesystem": true
    ...
    <tr>
      <td id="sygnal--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L920">sygnal.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"150m"
    ...
    <tr>
      <td id="sygnal--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L922">sygnal.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"45Mi"
    ...
    <tr>
      <td id="sygnal--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L925">sygnal.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"150m"
    ...
    <tr>
      <td id="sygnal--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L927">sygnal.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"45Mi"
    ...
    <tr>
      <td id="sygnal--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L933">sygnal.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Pfad des Healthchecks</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="sygnal--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L935">sygnal.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Port des Healthchecks</td>
      <td>
...
"http"
    ...
    <tr>
      <td id="sygnal--readinessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L941">sygnal.readinessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Pfads vom Bereitschaftscheck</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="sygnal--readinessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L943">sygnal.readinessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Ports vom Bereitschaftscheck</td>
      <td>
...
"http"
    ...
    <tr>
      <td id="sygnal--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L946">sygnal.nodeSelector</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="sygnal--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L949">sygnal.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="sygnal--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L952">sygnal.affinity</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="sygnal--apns">
        <div style="max-width: 150px;"><a href="../values.yaml#L960">sygnal.apns</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="sygnal--ios_push--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L965">sygnal.ios_push.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="sygnal--ios_push--ioskey_filename">
        <div style="max-width: 150px;"><a href="../values.yaml#L972">sygnal.ios_push.ioskey_filename</a></div>
      </td>
      <td>map</td>
...
""
    ...
    <tr>
      <td id="sygnal--ios_push--ioskey_keyvalue">
        <div style="max-width: 150px;"><a href="../values.yaml#L973">sygnal.ios_push.ioskey_keyvalue</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="wellknown--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L985">wellknown.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="wellknown--server">
        <div style="max-width: 150px;"><a href="../values.yaml#L990">wellknown.server</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="wellknown--client">
        <div style="max-width: 150px;"><a href="../values.yaml#L1002">wellknown.client</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="wellknown--extraData">
        <div style="max-width: 150px;"><a href="../values.yaml#L1013">wellknown.extraData</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="wellknown--htdocsPath">
        <div style="max-width: 150px;"><a href="../values.yaml#L1017">wellknown.htdocsPath</a></div>
      </td>
      <td>path</td>
...
"/usr/share/nginx/html"
    ...
    <tr>
      <td id="wellknown--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1023">wellknown.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v1.18.0"
    ...
    <tr>
      <td id="wellknown--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1031">wellknown.podSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="wellknown--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1040">wellknown.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsNonRoot": true
    ...
    <tr>
      <td id="wellknown--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1048">wellknown.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="wellknown--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1050">wellknown.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="wellknown--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1053">wellknown.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="wellknown--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1055">wellknown.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="wellknown--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L1058">wellknown.nodeSelector</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="wellknown--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L1061">wellknown.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="wellknown--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L1064">wellknown.affinity</a></div>
      </td>
      <td>object</td>
  ...
  <tbody>
    <tr>
      <td id="postgresql--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1078">postgresql.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="postgresql--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1082">postgresql.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "14"
    ...
    <tr>
      <td id="postgresql--auth--database">
        <div style="max-width: 150px;"><a href="../values.yaml#L1090">postgresql.auth.database</a></div>
      </td>
      <td>string</td>
...
"synapse_db"
    ...
    <tr>
      <td id="postgresql--auth--username">
        <div style="max-width: 150px;"><a href="../values.yaml#L1093">postgresql.auth.username</a></div>
      </td>
      <td>string</td>
...
"synapse"
    ...
    <tr>
      <td id="postgresql--auth--password">
        <div style="max-width: 150px;"><a href="../values.yaml#L1096">postgresql.auth.password</a></div>
      </td>
      <td>string</td>
...
"synapse"
    ...
    <tr>
      <td id="postgresql--auth--existingSecret">
        <div style="max-width: 150px;"><a href="../values.yaml#L1100">postgresql.auth.existingSecret</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="postgresql--auth--secretKeys--userPasswordKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L1104">postgresql.auth.secretKeys.userPasswordKey</a></div>
      </td>
      <td>string</td>
...
"password"
    ...
    <tr>
      <td id="postgresql--auth--secretKeys--adminPasswordKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L1107">postgresql.auth.secretKeys.adminPasswordKey</a></div>
      </td>
      <td>string</td>
...
"postgres-password"
    ...
    <tr>
      <td id="postgresql--primary--initdb--args">
        <div style="max-width: 150px;"><a href="../values.yaml#L1112">postgresql.primary.initdb.args</a></div>
      </td>
      <td>string</td>
...
"--lc-collate=C --lc-ctype=C --encoding=UTF8"
    ...
    <tr>
      <td id="postgresql--primary--persistence">
        <div style="max-width: 150px;"><a href="../values.yaml#L1115">postgresql.primary.persistence</a></div>
      </td>
      <td>map</td>
  ...
  "storageClass": ""
    ...
    <tr>
      <td id="postgresql--extraArgs">
        <div style="max-width: 150px;"><a href="../values.yaml#L1121">postgresql.extraArgs</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="externalPostgresql">
        <div style="max-width: 150px;"><a href="../values.yaml#L1127">externalPostgresql</a></div>
      </td>
      <td>map</td>
  ...
  "username": "synapse"
    ...
    <tr>
      <td id="externalPostgresql--database">
        <div style="max-width: 150px;"><a href="../values.yaml#L1131">externalPostgresql.database</a></div>
      </td>
      <td>string</td>
...
"synapse_db"
    ...
    <tr>
      <td id="externalPostgresql--username">
        <div style="max-width: 150px;"><a href="../values.yaml#L1134">externalPostgresql.username</a></div>
      </td>
      <td>string</td>
      <td>Name für PostgreSQL Nutzer</td>
      <td>
...
"synapse"
    ...
    <tr>
      <td id="externalPostgresql--password">
        <div style="max-width: 150px;"><a href="../values.yaml#L1137">externalPostgresql.password</a></div>
      </td>
      <td>string</td>
      <td>Passwort für PostgreSQL Nutzer</td>
      <td>
...
"synapse"
    ...
    <tr>
      <td id="externalPostgresql--existingSecret">
        <div style="max-width: 150px;"><a href="../values.yaml#L1140">externalPostgresql.existingSecret</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="externalPostgresql--existingSecretPasswordKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L1143">externalPostgresql.existingSecretPasswordKey</a></div>
      </td>
      <td>string</td>
...
"password"
    ...
    <tr>
      <td id="externalPostgresql--extraArgs">
        <div style="max-width: 150px;"><a href="../values.yaml#L1149">externalPostgresql.extraArgs</a></div>
      </td>
      <td>list</td>
      <td>Zusätzliche Argumente für die Datenbankverbindung ref: https://github.com/matrix-org/synapse/blob/develop/docs/postgres.md#synapse-config</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="redis--image--registry">
        <div style="max-width: 150px;"><a href="../values.yaml#L1161">redis.image.registry</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"registry.opencode.de"
    ...
    <tr>
      <td id="redis--image--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L1162">redis.image.repository</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"bwi/bundesmessenger/backend/container-images/jammy-redis-production"
    ...
    <tr>
      <td id="redis--image--tag">
        <div style="max-width: 150px;"><a href="../values.yaml#L1163">redis.image.tag</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"v6.0.16"
    ...
    <tr>
      <td id="redis--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1168">redis.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="redis--auth">
        <div style="max-width: 150px;"><a href="../values.yaml#L1172">redis.auth</a></div>
      </td>
      <td>map</td>
        ...
        <div style="max-width: 300px;"><pre lang="json">
{
  ...
  "password": "synapse"
    ...
    <tr>
      <td id="redis--sysctl">
        <div style="max-width: 150px;"><a href="../values.yaml#L1180">redis.sysctl</a></div>
      </td>
      <td>map</td>
  ...
  "resources": {
    ...
    <tr>
      <td id="redis--architecture">
        <div style="max-width: 150px;"><a href="../values.yaml#L1203">redis.architecture</a></div>
      </td>
      <td>string</td>
...
"standalone"
    ...
    <tr>
      <td id="redis--master--kind">
        <div style="max-width: 150px;"><a href="../values.yaml#L1205">redis.master.kind</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"StatefulSet"
    ...
    <tr>
      <td id="redis--master--persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1210">redis.master.persistence.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="redis--master--service--ports--redis">
        <div style="max-width: 150px;"><a href="../values.yaml#L1214">redis.master.service.ports.redis</a></div>
      </td>
      <td>int</td>
      <td>Serviceport</td>
      <td>
...
6379
    ...
    <tr>
      <td id="externalRedis">
        <div style="max-width: 150px;"><a href="../values.yaml#L1223">externalRedis</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="ingress--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1242">ingress.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--traefikPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1246">ingress.traefikPaths</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/use-regex"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1252">ingress.annotations."nginx.ingress.kubernetes.io/use-regex"</a></div>
      </td>
      <td>bool</td>
...
"true"
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/proxy-body-size"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1254">ingress.annotations."nginx.ingress.kubernetes.io/proxy-body-size"</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/enable-owasp-core-rules"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1255">ingress.annotations."nginx.ingress.kubernetes.io/enable-owasp-core-rules"</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"true"
    ...
    <tr>
      <td id="ingress--csHosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1264">ingress.csHosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--hosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1271">ingress.hosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--wkHosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1278">ingress.wkHosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1295">ingress.paths</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1312">ingress.csPaths</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--includeUnderscoreSynapse">
        <div style="max-width: 150px;"><a href="../values.yaml#L1315">ingress.includeUnderscoreSynapse</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--includeServerName">
        <div style="max-width: 150px;"><a href="../values.yaml#L1319">ingress.includeServerName</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--tls">
        <div style="max-width: 150px;"><a href="../values.yaml#L1331">ingress.tls</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--className">
        <div style="max-width: 150px;"><a href="../values.yaml#L1336">ingress.className</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="contentscanner--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1344">contentscanner.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="contentscanner--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1346">contentscanner.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v1.0.3"
    ...
    <tr>
      <td id="contentscanner--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L1351">contentscanner.replicaCount</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
1
    ...
    <tr>
      <td id="contentscanner--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1355">contentscanner.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="contentscanner--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1357">contentscanner.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"1Gi"
    ...
    <tr>
      <td id="contentscanner--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1360">contentscanner.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="contentscanner--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1362">contentscanner.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"500Mi"
    ...
    <tr>
      <td id="contentscanner--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1367">contentscanner.podSecurityContext</a></div>
      </td>
      <td>map</td>
      <td>Informationen zum Sicherheitskontext, die dem Container mitgeteilt werden sollen. weitere Möglichkeiten:  fsGroup: 1001</td>
      <td>
  ...
  "runAsUser": 1334
    ...
    <tr>
      <td id="contentscanner--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1376">contentscanner.securityContext</a></div>
      </td>
      <td>map</td>
      <td>Konfiguration für die Container-Sicherheitsrichtlinie weitere Möglichkeiten:  capabilities:    drop:    - ALL</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="schadcodescanner--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1386">schadcodescanner.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="schadcodescanner--imageclamav">
        <div style="max-width: 150px;"><a href="../values.yaml#L1388">schadcodescanner.imageclamav</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v0.103.6"
    ...
    <tr>
      <td id="schadcodescanner--imagecicap">
        <div style="max-width: 150px;"><a href="../values.yaml#L1393">schadcodescanner.imagecicap</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v0.5.6"
    ...
    <tr>
      <td id="schadcodescanner--persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1400">schadcodescanner.persistence.enabled</a></div>
      </td>
      <td>bool</td>
      <td></td>
      <td>
...
true
    ...
    <tr>
      <td id="schadcodescanner--persistence--existingClaim">
        <div style="max-width: 150px;"><a href="../values.yaml#L1403">schadcodescanner.persistence.existingClaim</a></div>
      </td>
      <td>string</td>
      <td>Name des VolumeClaims</td>
      <td>
...
leer, damit dynamische Volumes genutzt werden können (dennoch persistent)
    ...
    <tr>
      <td id="schadcodescanner--persistence--storageClass">
        <div style="max-width: 150px;"><a href="../values.yaml#L1405">schadcodescanner.persistence.storageClass</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="schadcodescanner--persistence--accessMode">
        <div style="max-width: 150px;"><a href="../values.yaml#L1407">schadcodescanner.persistence.accessMode</a></div>
      </td>
      <td>string</td>
...
"ReadWriteOnce"
    ...
    <tr>
      <td id="schadcodescanner--persistence--size">
        <div style="max-width: 150px;"><a href="../values.yaml#L1409">schadcodescanner.persistence.size</a></div>
      </td>
      <td>string</td>
      <td>Größe des zu nutzenden Volumes</td>
      <td>
...
"10Gi"
    ...
    <tr>
      <td id="schadcodescanner--extraEnv">
        <div style="max-width: 150px;"><a href="../values.yaml#L1419">schadcodescanner.extraEnv</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="schadcodescanner--service--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1424">schadcodescanner.service.port</a></div>
      </td>
      <td>int</td>
...
1344
    ...
    <tr>
      <td id="schadcodescanner--freshclam--mirrors">
        <div style="max-width: 150px;"><a href="../values.yaml#L1428">schadcodescanner.freshclam.mirrors</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"database.clamav.net"
    ...
    <tr>
      <td id="schadcodescanner--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L1433">schadcodescanner.replicaCount</a></div>
      </td>
      <td>int</td>
...
1
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1440">schadcodescanner.autoscaling.enabled</a></div>
      </td>
      <td>bool</td>
      <td>schalte das HPA für die Container ein Hinweis: Kann für alle spezifischen Worker benutzt werden Dazu muss entsprechende Konfiguration in die separaten Sektionen eingefügt werden</td>
      <td>
...
false
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--minReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L1442">schadcodescanner.autoscaling.minReplicas</a></div>
      </td>
      <td>int</td>
      <td>minimale Anzahl der Worker-Container</td>
      <td>
...
1
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--maxReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L1444">schadcodescanner.autoscaling.maxReplicas</a></div>
      </td>
      <td>int</td>
      <td>maximale Anzahl der Worker-Container</td>
      <td>
...
4
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--targetCPUUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L1446">schadcodescanner.autoscaling.targetCPUUtilizationPercentage</a></div>
      </td>
      <td>int</td>
      <td>Prozentsatz für CPU-Auslastung um Scaling zu triggern</td>
      <td>
...
90
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--targetMemoryUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L1448">schadcodescanner.autoscaling.targetMemoryUtilizationPercentage</a></div>
      </td>
      <td>int</td>
      <td>Prozentsatz für RAM-Auslastung um Scaling zu triggern</td>
      <td>
...
80
    ...
    <tr>
      <td id="schadcodescanner--limits--fileSize">
        <div style="max-width: 150px;"><a href="../values.yaml#L1452">schadcodescanner.limits.fileSize</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
50
    ...
    <tr>
      <td id="schadcodescanner--limits--scanSize">
        <div style="max-width: 150px;"><a href="../values.yaml#L1454">schadcodescanner.limits.scanSize</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
100
    ...
    <tr>
      <td id="schadcodescanner--limits--connectionQueueLength">
        <div style="max-width: 150px;"><a href="../values.yaml#L1456">schadcodescanner.limits.connectionQueueLength</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
100
    ...
    <tr>
      <td id="schadcodescanner--limits--maxThreads">
        <div style="max-width: 150px;"><a href="../values.yaml#L1458">schadcodescanner.limits.maxThreads</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
4
    ...
    <tr>
      <td id="schadcodescanner--limits--sendBufTimeout">
        <div style="max-width: 150px;"><a href="../values.yaml#L1460">schadcodescanner.limits.sendBufTimeout</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
500
    ...
    <tr>
      <td id="schadcodescanner--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1465">schadcodescanner.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"1500m"
    ...
    <tr>
      <td id="schadcodescanner--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1467">schadcodescanner.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"4Gi"
    ...
    <tr>
      <td id="schadcodescanner--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1470">schadcodescanner.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="schadcodescanner--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1472">schadcodescanner.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"2Gi"
    ...
    <tr>
      <td id="schadcodescanner--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1477">schadcodescanner.podSecurityContext</a></div>
      </td>
      <td>map</td>
      <td>Informationen zum Sicherheitskontext, die dem Container mitgeteilt werden sollen. weitere Möglichkeiten:  fsGroup: 1001</td>
      <td>
  ...
  "runAsNonRoot": true
    ...
    <tr>
      <td id="schadcodescanner--clamavSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1485">schadcodescanner.clamavSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 1111
    ...
    <tr>
      <td id="schadcodescanner--icapSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1495">schadcodescanner.icapSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="coturn--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1512">coturn.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="coturn--turnUris">
        <div style="max-width: 150px;"><a href="../values.yaml#L1519">coturn.turnUris</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="coturn--existingcoturn--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1523">coturn.existingcoturn.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="coturn--default_ns">
        <div style="max-width: 150px;"><a href="../values.yaml#L1525">coturn.default_ns</a></div>
      </td>
      <td>string</td>
...
"default"
    ...
    <tr>
      <td id="coturn--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1527">coturn.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "Hier das Tag für das Image des Coturn eintragen - NICHT EMPFOHLEN!"
    ...
    <tr>
      <td id="coturn--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1532">coturn.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="synapse_admin--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1545">synapse_admin.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="synapse_admin--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L1547">synapse_admin.uri</a></div>
      </td>
      <td>string</td>
...
null
    ...
    <tr>
      <td id="synapse_admin--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1549">synapse_admin.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v0.8.5"
    ...
    <tr>
      <td id="synapse_admin--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1558">synapse_admin.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="synapse_admin--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1560">synapse_admin.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="synapse_admin--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1563">synapse_admin.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="synapse_admin--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1565">synapse_admin.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="synapse_admin--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1571">synapse_admin.podSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="synapse_admin--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1579">synapse_admin.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="webclient--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1614">webclient.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="webclient--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L1616">webclient.uri</a></div>
      </td>
      <td>string</td>
...
null
    ...
    <tr>
      <td id="webclient--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1618">webclient.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v2.1.0"
    ...
    <tr>
      <td id="webclient--annotations--"nginx--ingress--kubernetes--io/configuration-snippet"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1623">webclient.annotations."nginx.ingress.kubernetes.io/configuration-snippet"</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"add_header X-Frame-Options SAMEORIGIN;\nadd_header X-Content-Type-Options nosniff;\nadd_header X-XSS-Protection \"1; mode=block\";\nadd_header Content-Security-Policy \"frame-ancestors 'none'\";\n"
    ...
    <tr>
      <td id="webclient--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1632">webclient.podSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="webclient--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1641">webclient.securityContext</a></div>
      </td>
      <td>map</td>
      <td>Konfiguration für die Container-Sicherheitsrichtlinie weitere Möglichkeiten:  capabilities:    drop:    - ALL</td>
      <td>
  ...
  "runAsNonRoot": true
    ...
    <tr>
      <td id="webclient--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1649">webclient.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"100m"
    ...
    <tr>
      <td id="webclient--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1651">webclient.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"90Mi"
    ...
    <tr>
      <td id="webclient--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1654">webclient.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="webclient--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1656">webclient.resources.requests.memory</a></div>
      </td>
      <td>string</td>
