...
![Version: 1.9.0](https://img.shields.io/badge/Version-1.9.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.105.1](https://img.shields.io/badge/AppVersion-1.105.1-informational?style=flat-square)
  ...
  <tbody>
    <tr>
      <td id="image--registry">
        <div style="max-width: 150px;"><a href="../values.yaml#L6">image.registry</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"registry.opencode.de"
    ...
    <tr>
      <td id="image--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L9">image.repository</a></div>
      </td>
      <td>string</td>
...
"bwi/bundesmessenger/backend/container-images/synapse"
    ...
    <tr>
      <td id="image--pullSecrets">
        <div style="max-width: 150px;"><a href="../values.yaml#L22">image.pullSecrets</a></div>
      </td>
      <td>list</td>
...
nicht gesetzt
    ...
    <tr>
      <td id="image--pullPolicy">
        <div style="max-width: 150px;"><a href="../values.yaml#L26">image.pullPolicy</a></div>
      </td>
      <td>string</td>
...
"IfNotPresent"
    ...
    <tr>
      <td id="nameOverride">
        <div style="max-width: 150px;"><a href="../values.yaml#L29">nameOverride</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="fullnameOverride">
        <div style="max-width: 150px;"><a href="../values.yaml#L32">fullnameOverride</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="serverName">
        <div style="max-width: 150px;"><a href="../values.yaml#L37">serverName</a></div>
      </td>
      <td>string</td>
...
Nicht gesetzt, aber Voraussetzung!
    ...
    <tr>
      <td id="publicServerName">
        <div style="max-width: 150px;"><a href="../values.yaml#L42">publicServerName</a></div>
      </td>
      <td>string</td>
...
Nicht gesetzt
    ...
    <tr>
      <td id="dataPrivacyUrl">
        <div style="max-width: 150px;"><a href="../values.yaml#L49">dataPrivacyUrl</a></div>
      </td>
      <td>string</td>
...
Nicht gesetzt, aber Voraussetzung!
    ...
    <tr>
      <td id="imprintUrl">
        <div style="max-width: 150px;"><a href="../values.yaml#L55">imprintUrl</a></div>
      </td>
      <td>string</td>
...
Nicht gesetzt, aber Voraussetzung!
    ...
    <tr>
      <td id="adminAPIServerName">
        <div style="max-width: 150px;"><a href="../values.yaml#L63">adminAPIServerName</a></div>
      </td>
      <td>string</td>
...
{}
    ...
    <tr>
      <td id="signingkey--job--generateImage--registry">
        <div style="max-width: 150px;"><a href="../values.yaml#L129">signingkey.job.generateImage.registry</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"registry.opencode.de"
    ...
    <tr>
      <td id="signingkey--job--generateImage--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L134">signingkey.job.generateImage.repository</a></div>
      </td>
      <td>string</td>
...
"bwi/bundesmessenger/backend/container-images/synapse"
    ...
    <tr>
      <td id="signingkey--job--generateImage--pullPolicy">
        <div style="max-width: 150px;"><a href="../values.yaml#L139">signingkey.job.generateImage.pullPolicy</a></div>
      </td>
      <td>string</td>
...
"IfNotPresent"
    ...
    <tr>
      <td id="signingkey--job--publishImage">
        <div style="max-width: 150px;"><a href="../values.yaml#L142">signingkey.job.publishImage</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "1.30.2-jammy-production"
    ...
    <tr>
      <td id="signingkey--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L153">signingkey.podSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="signingkey--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L158">signingkey.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="signingkey--readinessProbe--exec--command[0]">
        <div style="max-width: 150px;"><a href="../values.yaml#L167">signingkey.readinessProbe.exec.command[0]</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"/bin/sh"
    ...
    <tr>
      <td id="signingkey--readinessProbe--exec--command[1]">
        <div style="max-width: 150px;"><a href="../values.yaml#L168">signingkey.readinessProbe.exec.command[1]</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"-c"
    ...
    <tr>
      <td id="signingkey--readinessProbe--exec--command[2]">
        <div style="max-width: 150px;"><a href="../values.yaml#L169">signingkey.readinessProbe.exec.command[2]</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"/scripts/signing-key-check.sh -o ready"
    ...
    <tr>
      <td id="signingkey--readinessProbe--initialDelaySeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L170">signingkey.readinessProbe.initialDelaySeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
5
    ...
    <tr>
      <td id="signingkey--readinessProbe--periodSeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L171">signingkey.readinessProbe.periodSeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
10
    ...
    <tr>
      <td id="signingkey--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L176">signingkey.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"100m"
    ...
    <tr>
      <td id="signingkey--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L177">signingkey.resources.limits.memory</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"250Mi"
    ...
    <tr>
      <td id="signingkey--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L179">signingkey.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"100m"
    ...
    <tr>
      <td id="signingkey--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L180">signingkey.resources.requests.memory</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"250Mi"
    ...
    <tr>
      <td id="signingkey--livenessProbe--exec--command[0]">
        <div style="max-width: 150px;"><a href="../values.yaml#L186">signingkey.livenessProbe.exec.command[0]</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"/bin/sh"
    ...
    <tr>
      <td id="signingkey--livenessProbe--exec--command[1]">
        <div style="max-width: 150px;"><a href="../values.yaml#L187">signingkey.livenessProbe.exec.command[1]</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"-c"
    ...
    <tr>
      <td id="signingkey--livenessProbe--exec--command[2]">
        <div style="max-width: 150px;"><a href="../values.yaml#L188">signingkey.livenessProbe.exec.command[2]</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"/scripts/signing-key-check.sh -o health"
    ...
    <tr>
      <td id="signingkey--livenessProbe--initialDelaySeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L189">signingkey.livenessProbe.initialDelaySeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
10
    ...
    <tr>
      <td id="signingkey--livenessProbe--periodSeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L190">signingkey.livenessProbe.periodSeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
15
    ...
    <tr>
      <td id="ipv4Only">
        <div style="max-width: 150px;"><a href="../values.yaml#L199">ipv4Only</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="config--logLevel">
        <div style="max-width: 150px;"><a href="../values.yaml#L219">config.logLevel</a></div>
      </td>
      <td>string</td>
...
"INFO"
    ...
    <tr>
      <td id="config--useRecommendedLogging">
        <div style="max-width: 150px;"><a href="../values.yaml#L225">config.useRecommendedLogging</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="config--useStructuredLogging">
        <div style="max-width: 150px;"><a href="../values.yaml#L230">config.useStructuredLogging</a></div>
      </td>
      <td>bool</td>
      <td></td>
      <td>
...
false
    ...
    <tr>
      <td id="config--extraLoggers">
        <div style="max-width: 150px;"><a href="../values.yaml#L239">config.extraLoggers</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="config--reportStats">
        <div style="max-width: 150px;"><a href="../values.yaml#L242">config.reportStats</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="config--enable_metrics">
        <div style="max-width: 150px;"><a href="../values.yaml#L245">config.enable_metrics</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="config--turnUris">
        <div style="max-width: 150px;"><a href="../values.yaml#L256">config.turnUris</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="config--enableRegistration">
        <div style="max-width: 150px;"><a href="../values.yaml#L263">config.enableRegistration</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="config--registrationSharedSecret">
        <div style="max-width: 150px;"><a href="../values.yaml#L266">config.registrationSharedSecret</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="config--macaroonSecretKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L269">config.macaroonSecretKey</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="config--extraListeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L272">config.extraListeners</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="config--trustedKeyServers">
        <div style="max-width: 150px;"><a href="../values.yaml#L286">config.trustedKeyServers</a></div>
      </td>
      <td>map</td>
...
empty Array, da so nur bekannte Server direkt angefragt werden,
    ...
    <tr>
      <td id="extraConfig">
        <div style="max-width: 150px;"><a href="../values.yaml#L292">extraConfig</a></div>
      </td>
      <td>object</td>
  ...
  "user_ips_max_age": "28d"
    ...
    <tr>
      <td id="extraConfig--max_upload_size">
        <div style="max-width: 150px;"><a href="../values.yaml#L298">extraConfig.max_upload_size</a></div>
      </td>
      <td>string</td>
...
"50M"
    ...
    <tr>
      <td id="extraConfig--max_avatar_size">
        <div style="max-width: 150px;"><a href="../values.yaml#L300">extraConfig.max_avatar_size</a></div>
      </td>
      <td>string</td>
...
"5M"
    ...
    <tr>
      <td id="extraConfig--media_retention">
        <div style="max-width: 150px;"><a href="../values.yaml#L303">extraConfig.media_retention</a></div>
      </td>
      <td>object</td>
  ...
  "remote_media_lifetime": "90d"
    ...
    <tr>
      <td id="extraConfig--media_retention--remote_media_lifetime">
        <div style="max-width: 150px;"><a href="../values.yaml#L309">extraConfig.media_retention.remote_media_lifetime</a></div>
      </td>
      <td>string</td>
...
"90d"
    ...
    <tr>
      <td id="extraConfig--require_auth_for_profile_requests">
        <div style="max-width: 150px;"><a href="../values.yaml#L311">extraConfig.require_auth_for_profile_requests</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--limit_profile_requests_to_users_who_share_rooms">
        <div style="max-width: 150px;"><a href="../values.yaml#L313">extraConfig.limit_profile_requests_to_users_who_share_rooms</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--include_profile_data_on_invite">
        <div style="max-width: 150px;"><a href="../values.yaml#L315">extraConfig.include_profile_data_on_invite</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--allow_public_rooms_without_auth">
        <div style="max-width: 150px;"><a href="../values.yaml#L317">extraConfig.allow_public_rooms_without_auth</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--block_non_admin_invites">
        <div style="max-width: 150px;"><a href="../values.yaml#L319">extraConfig.block_non_admin_invites</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--ip_range_whitelist">
        <div style="max-width: 150px;"><a href="../values.yaml#L321">extraConfig.ip_range_whitelist</a></div>
      </td>
      <td>list</td>
  ...
  "192.168.0.0/16"
    ...
    <tr>
      <td id="extraConfig--presence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L324">extraConfig.presence.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--enable_search">
        <div style="max-width: 150px;"><a href="../values.yaml#L326">extraConfig.enable_search</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--user_directory--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L329">extraConfig.user_directory.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--user_directory--search_all_users">
        <div style="max-width: 150px;"><a href="../values.yaml#L331">extraConfig.user_directory.search_all_users</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--require_membership_for_aliases">
        <div style="max-width: 150px;"><a href="../values.yaml#L333">extraConfig.require_membership_for_aliases</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--delete_stale_devices_after">
        <div style="max-width: 150px;"><a href="../values.yaml#L336">extraConfig.delete_stale_devices_after</a></div>
      </td>
      <td>string</td>
...
"90d"
    ...
    <tr>
      <td id="extraConfig--user_ips_max_age">
        <div style="max-width: 150px;"><a href="../values.yaml#L338">extraConfig.user_ips_max_age</a></div>
      </td>
      <td>string</td>
...
"28d"
    ...
    <tr>
      <td id="extraConfig--forget_rooms_on_leave">
        <div style="max-width: 150px;"><a href="../values.yaml#L342">extraConfig.forget_rooms_on_leave</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--forgotten_room_retention_period">
        <div style="max-width: 150px;"><a href="../values.yaml#L345">extraConfig.forgotten_room_retention_period</a></div>
      </td>
      <td>string</td>
...
"28d"
    ...
    <tr>
      <td id="extraConfig--retention--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L348">extraConfig.retention.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--url_preview_enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L350">extraConfig.url_preview_enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--oembed--disable_default_providers">
        <div style="max-width: 150px;"><a href="../values.yaml#L353">extraConfig.oembed.disable_default_providers</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--enable_3pid_lookup">
        <div style="max-width: 150px;"><a href="../values.yaml#L355">extraConfig.enable_3pid_lookup</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--allow_guest_access">
        <div style="max-width: 150px;"><a href="../values.yaml#L357">extraConfig.allow_guest_access</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--password_config">
        <div style="max-width: 150px;"><a href="../values.yaml#L359">extraConfig.password_config</a></div>
      </td>
      <td>object</td>
  ...
  "policy": {
    ...
    <tr>
      <td id="extraConfig--password_config--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L361">extraConfig.password_config.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--localdb_enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L364">extraConfig.password_config.localdb_enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L367">extraConfig.password_config.policy.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--minimum_length">
        <div style="max-width: 150px;"><a href="../values.yaml#L369">extraConfig.password_config.policy.minimum_length</a></div>
      </td>
      <td>int</td>
...
8
    ...
    <tr>
      <td id="extraConfig--password_config--policy--require_digit">
        <div style="max-width: 150px;"><a href="../values.yaml#L371">extraConfig.password_config.policy.require_digit</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--require_symbol">
        <div style="max-width: 150px;"><a href="../values.yaml#L373">extraConfig.password_config.policy.require_symbol</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--require_lowercase">
        <div style="max-width: 150px;"><a href="../values.yaml#L375">extraConfig.password_config.policy.require_lowercase</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--require_uppercase">
        <div style="max-width: 150px;"><a href="../values.yaml#L377">extraConfig.password_config.policy.require_uppercase</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--ui_auth--session_timeout">
        <div style="max-width: 150px;"><a href="../values.yaml#L380">extraConfig.ui_auth.session_timeout</a></div>
      </td>
      <td>string</td>
...
"15s"
    ...
    <tr>
      <td id="extraConfig--push--include_content">
        <div style="max-width: 150px;"><a href="../values.yaml#L383">extraConfig.push.include_content</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--encryption_enabled_by_default_for_room_type">
        <div style="max-width: 150px;"><a href="../values.yaml#L385">extraConfig.encryption_enabled_by_default_for_room_type</a></div>
      </td>
      <td>string</td>
...
"all"
    ...
    <tr>
      <td id="extraConfig--stats--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L391">extraConfig.stats.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--enable_room_list_search">
        <div style="max-width: 150px;"><a href="../values.yaml#L393">extraConfig.enable_room_list_search</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--opentracing--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L399">extraConfig.opentracing.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--dynamic_thumbnails">
        <div style="max-width: 150px;"><a href="../values.yaml#L401">extraConfig.dynamic_thumbnails</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--allow_public_rooms_over_federation">
        <div style="max-width: 150px;"><a href="../values.yaml#L406">extraConfig.allow_public_rooms_over_federation</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--federation_domain_whitelist">
        <div style="max-width: 150px;"><a href="../values.yaml#L408">extraConfig.federation_domain_whitelist</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="extraConfig--prevent_media_downloads_from">
        <div style="max-width: 150px;"><a href="../values.yaml#L414">extraConfig.prevent_media_downloads_from</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="extraConfig--federation_custom_ca_list">
        <div style="max-width: 150px;"><a href="../values.yaml#L430">extraConfig.federation_custom_ca_list</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="extraConfig--federation--client_timeout">
        <div style="max-width: 150px;"><a href="../values.yaml#L445">extraConfig.federation.client_timeout</a></div>
      </td>
      <td>string</td>
...
60s
    ...
    <tr>
      <td id="extraConfig--federation--max_short_retry_delay">
        <div style="max-width: 150px;"><a href="../values.yaml#L448">extraConfig.federation.max_short_retry_delay</a></div>
      </td>
      <td>string</td>
...
2s
    ...
    <tr>
      <td id="extraConfig--federation--max_long_retry_delay">
        <div style="max-width: 150px;"><a href="../values.yaml#L451">extraConfig.federation.max_long_retry_delay</a></div>
      </td>
      <td>string</td>
...
60s
    ...
    <tr>
      <td id="extraConfig--federation--max_short_retries">
        <div style="max-width: 150px;"><a href="../values.yaml#L454">extraConfig.federation.max_short_retries</a></div>
      </td>
      <td>int</td>
...
3
    ...
    <tr>
      <td id="extraConfig--federation--max_long_retries">
        <div style="max-width: 150px;"><a href="../values.yaml#L457">extraConfig.federation.max_long_retries</a></div>
      </td>
      <td>int</td>
...
10
    ...
    <tr>
      <td id="extraConfig--federation--destination_min_retry_interval">
        <div style="max-width: 150px;"><a href="../values.yaml#L465">extraConfig.federation.destination_min_retry_interval</a></div>
      </td>
      <td>string</td>
...
10m
    ...
    <tr>
      <td id="extraConfig--federation--destination_retry_multiplier">
        <div style="max-width: 150px;"><a href="../values.yaml#L468">extraConfig.federation.destination_retry_multiplier</a></div>
      </td>
      <td>string</td>
...
2
    ...
    <tr>
      <td id="extraConfig--federation--destination_max_retry_interval">
        <div style="max-width: 150px;"><a href="../values.yaml#L471">extraConfig.federation.destination_max_retry_interval</a></div>
      </td>
      <td>string</td>
...
1w
    ...
    <tr>
      <td id="extraSecrets">
        <div style="max-width: 150px;"><a href="../values.yaml#L479">extraSecrets</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="synapse">
        <div style="max-width: 150px;"><a href="../values.yaml#L483">synapse</a></div>
      </td>
      <td>object</td>
...
wird nachfolgend einzeln aufgeschlüsselt
    ...
    <tr>
      <td id="synapse--strategy--type">
        <div style="max-width: 150px;"><a href="../values.yaml#L490">synapse.strategy.type</a></div>
      </td>
      <td>string</td>
...
"RollingUpdate"
    ...
    <tr>
      <td id="synapse--annotations">
        <div style="max-width: 150px;"><a href="../values.yaml#L493">synapse.annotations</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="synapse--labels">
        <div style="max-width: 150px;"><a href="../values.yaml#L496">synapse.labels</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="synapse--extraEnv">
        <div style="max-width: 150px;"><a href="../values.yaml#L516">synapse.extraEnv</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="synapse--extraVolumes">
        <div style="max-width: 150px;"><a href="../values.yaml#L523">synapse.extraVolumes</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="synapse--extraVolumeMounts">
        <div style="max-width: 150px;"><a href="../values.yaml#L530">synapse.extraVolumeMounts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="synapse--extraCommands">
        <div style="max-width: 150px;"><a href="../values.yaml#L536">synapse.extraCommands</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="synapse--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L544">synapse.podSecurityContext</a></div>
      </td>
      <td>object</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="synapse--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L552">synapse.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="synapse--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L574">synapse.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"1500m"
    ...
    <tr>
      <td id="synapse--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L576">synapse.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"2000Mi"
    ...
    <tr>
      <td id="synapse--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L579">synapse.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="synapse--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L581">synapse.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"1000Mi"
    ...
    <tr>
      <td id="synapse--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L588">synapse.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="synapse--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L590">synapse.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="synapse--readinessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L597">synapse.readinessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="synapse--readinessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L599">synapse.readinessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="synapse--startupProbe--failureThreshold">
        <div style="max-width: 150px;"><a href="../values.yaml#L604">synapse.startupProbe.failureThreshold</a></div>
      </td>
      <td>int</td>
...
6
    ...
    <tr>
      <td id="synapse--startupProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L608">synapse.startupProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="synapse--startupProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L611">synapse.startupProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="synapse--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L615">synapse.nodeSelector</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="synapse--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L642">synapse.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="synapse--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L645">synapse.affinity</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="workers--default--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L661">workers.default.replicaCount</a></div>
      </td>
      <td>int</td>
...
1
    ...
    <tr>
      <td id="workers--default--strategy--type">
        <div style="max-width: 150px;"><a href="../values.yaml#L669">workers.default.strategy.type</a></div>
      </td>
      <td>string</td>
...
"RollingUpdate"
    ...
    <tr>
      <td id="workers--default--name">
        <div style="max-width: 150px;"><a href="../values.yaml#L674">workers.default.name</a></div>
      </td>
      <td>string</td>
...
"nil"
    ...
    <tr>
      <td id="workers--default--extraConfig">
        <div style="max-width: 150px;"><a href="../values.yaml#L677">workers.default.extraConfig</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="workers--default--annotations">
        <div style="max-width: 150px;"><a href="../values.yaml#L680">workers.default.annotations</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="workers--default--extraEnv">
        <div style="max-width: 150px;"><a href="../values.yaml#L688">workers.default.extraEnv</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="workers--default--volumes">
        <div style="max-width: 150px;"><a href="../values.yaml#L694">workers.default.volumes</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="workers--default--volumeMounts">
        <div style="max-width: 150px;"><a href="../values.yaml#L698">workers.default.volumeMounts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="workers--default--extraCommands">
        <div style="max-width: 150px;"><a href="../values.yaml#L705">workers.default.extraCommands</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="workers--default--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L709">workers.default.podSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="workers--default--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L724">workers.default.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="workers--default--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L734">workers.default.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"600m"
    ...
    <tr>
      <td id="workers--default--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L738">workers.default.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"768Mi"
    ...
    <tr>
      <td id="workers--default--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L743">workers.default.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"100m"
    ...
    <tr>
      <td id="workers--default--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L747">workers.default.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"150Mi"
    ...
    <tr>
      <td id="workers--default--livenessProbe--periodSeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L751">workers.default.livenessProbe.periodSeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
10
    ...
    <tr>
      <td id="workers--default--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L755">workers.default.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="workers--default--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L758">workers.default.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="workers--default--readinessProbe--periodSeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L762">workers.default.readinessProbe.periodSeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
3
    ...
    <tr>
      <td id="workers--default--readinessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L766">workers.default.readinessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="workers--default--readinessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L769">workers.default.readinessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="workers--default--startupProbe--failureThreshold">
        <div style="max-width: 150px;"><a href="../values.yaml#L774">workers.default.startupProbe.failureThreshold</a></div>
      </td>
      <td>int</td>
      <td>Anzahl der Fehlversuche, damit Startzeit für Worker bei 60 Sekunden landet; Timeout default bei 10 Sekunden</td>
      <td>
...
6
    ...
    <tr>
      <td id="workers--default--startupProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L778">workers.default.startupProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Pfads vom Startup-Check DEFAULT gilt für alle Synapse-Worker-Container.</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="workers--default--startupProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L781">workers.default.startupProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Ports vom Startup-Check DEFAULT gilt für alle Synapse-Worker-Container.</td>
      <td>
...
"metrics"
    ...
    <tr>
      <td id="workers--default--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L785">workers.default.nodeSelector</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="workers--default--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L789">workers.default.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="workers--default--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L793">workers.default.affinity</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="workers--generic_worker--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L802">workers.generic_worker.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="workers--generic_worker--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L804">workers.generic_worker.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "federation"
    ...
    <tr>
      <td id="workers--generic_worker--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L807">workers.generic_worker.csPaths</a></div>
      </td>
      <td>list</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--generic_worker--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L888">workers.generic_worker.paths</a></div>
      </td>
      <td>list</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--generic_worker--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L917">workers.generic_worker.replicaCount</a></div>
      </td>
      <td>int</td>
...
2
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L928">workers.generic_worker.autoscaling.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--minReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L930">workers.generic_worker.autoscaling.minReplicas</a></div>
      </td>
      <td>int</td>
...
2
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--maxReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L932">workers.generic_worker.autoscaling.maxReplicas</a></div>
      </td>
      <td>int</td>
...
10
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--targetCPUUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L934">workers.generic_worker.autoscaling.targetCPUUtilizationPercentage</a></div>
      </td>
      <td>int</td>
...
80
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--targetMemoryUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L936">workers.generic_worker.autoscaling.targetMemoryUtilizationPercentage</a></div>
      </td>
      <td>int</td>
...
80
    ...
    <tr>
      <td id="workers--federation_reader--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L947">workers.federation_reader.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--federation_reader--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L949">workers.federation_reader.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "federation"
    ...
    <tr>
      <td id="workers--federation_reader--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L952">workers.federation_reader.paths</a></div>
      </td>
      <td>path</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--pusher--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L981">workers.pusher.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--appservice--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L986">workers.appservice.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--federation_sender--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L991">workers.federation_sender.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--media_repository--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L997">workers.media_repository.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="workers--media_repository--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L999">workers.media_repository.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "media"
    ...
    <tr>
      <td id="workers--media_repository--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1002">workers.media_repository.csPaths</a></div>
      </td>
      <td>list</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--media_repository--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1013">workers.media_repository.paths</a></div>
      </td>
      <td>list</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--media_repository--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1019">workers.media_repository.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"2000m"
    ...
    <tr>
      <td id="workers--media_repository--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1021">workers.media_repository.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"2500Mi"
    ...
    <tr>
      <td id="workers--media_repository--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1024">workers.media_repository.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="workers--media_repository--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1026">workers.media_repository.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"1500Mi"
    ...
    <tr>
      <td id="workers--media_repository--extraConfig">
        <div style="max-width: 150px;"><a href="../values.yaml#L1029">workers.media_repository.extraConfig</a></div>
      </td>
      <td>object</td>
      <td>Zusätzliche Konfiguration für die Worker</td>
      <td>
  ...
  "enable_media_repo": true
    ...
    <tr>
      <td id="workers--user_dir--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1038">workers.user_dir.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--user_dir--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L1040">workers.user_dir.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "client"
    ...
    <tr>
      <td id="workers--user_dir--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1043">workers.user_dir.csPaths</a></div>
      </td>
      <td>list</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--background_worker--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1049">workers.background_worker.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1056">persistence.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="persistence--existingClaim">
        <div style="max-width: 150px;"><a href="../values.yaml#L1059">persistence.existingClaim</a></div>
      </td>
      <td>string</td>
...
leerer Wert lässt dynamisches Provisionieren zu
    ...
    <tr>
      <td id="persistence--storageClass">
        <div style="max-width: 150px;"><a href="../values.yaml#L1061">persistence.storageClass</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="persistence--accessMode">
        <div style="max-width: 150px;"><a href="../values.yaml#L1063">persistence.accessMode</a></div>
      </td>
      <td>string</td>
      <td>Zugriffsmodus</td>
      <td>
...
"ReadWriteOnce"
    ...
    <tr>
      <td id="persistence--size">
        <div style="max-width: 150px;"><a href="../values.yaml#L1065">persistence.size</a></div>
      </td>
      <td>string</td>
...
"10Gi"
    ...
    <tr>
      <td id="volumePermissions--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1070">volumePermissions.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="volumePermissions--uid">
        <div style="max-width: 150px;"><a href="../values.yaml#L1072">volumePermissions.uid</a></div>
      </td>
      <td>int</td>
      <td>Nutzer-ID</td>
      <td>
...
2666
    ...
    <tr>
      <td id="volumePermissions--gid">
        <div style="max-width: 150px;"><a href="../values.yaml#L1074">volumePermissions.gid</a></div>
      </td>
      <td>int</td>
      <td>Gruppen-ID</td>
      <td>
...
2666
    ...
    <tr>
      <td id="volumePermissions--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1076">volumePermissions.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 0
    ...
    <tr>
      <td id="volumePermissions--image--registry">
        <div style="max-width: 150px;"><a href="../values.yaml#L1081">volumePermissions.image.registry</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"registry.opencode.de"
    ...
    <tr>
      <td id="volumePermissions--image--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L1083">volumePermissions.image.repository</a></div>
      </td>
      <td>string</td>
...
"bwi/bundesmessenger/backend/container-images/ubuntu"
    ...
    <tr>
      <td id="volumePermissions--image--tag">
        <div style="max-width: 150px;"><a href="../values.yaml#L1086">volumePermissions.image.tag</a></div>
      </td>
      <td>string</td>
...
"latest-jammy-production"
    ...
    <tr>
      <td id="volumePermissions--image--pullPolicy">
        <div style="max-width: 150px;"><a href="../values.yaml#L1088">volumePermissions.image.pullPolicy</a></div>
      </td>
      <td>string</td>
...
"IfNotPresent"
    ...
    <tr>
      <td id="volumePermissions--resources">
        <div style="max-width: 150px;"><a href="../values.yaml#L1097">volumePermissions.resources</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="service--type">
        <div style="max-width: 150px;"><a href="../values.yaml#L1105">service.type</a></div>
      </td>
      <td>string</td>
...
"ClusterIP"
    ...
    <tr>
      <td id="service--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1107">service.port</a></div>
      </td>
      <td>int</td>
...
8008
    ...
    <tr>
      <td id="service--targetPort">
        <div style="max-width: 150px;"><a href="../values.yaml#L1109">service.targetPort</a></div>
      </td>
      <td>int</td>
  ...
  <tbody>
    <tr>
      <td id="sygnal--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1119">sygnal.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="sygnal--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1121">sygnal.image</a></div>
      </td>
      <td>maps</td>
        ...
        <div style="max-width: 300px;"><pre lang="json">
{
  ...
  "tag": "0.14.3-jammy-production"
    ...
    <tr>
      <td id="sygnal--proxy">
        <div style="max-width: 150px;"><a href="../values.yaml#L1131">sygnal.proxy</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="sygnal--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1143">sygnal.podSecurityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="sygnal--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1152">sygnal.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "readOnlyRootFilesystem": true
    ...
    <tr>
      <td id="sygnal--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1159">sygnal.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="sygnal--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1161">sygnal.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"100Mi"
    ...
    <tr>
      <td id="sygnal--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1164">sygnal.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"150m"
    ...
    <tr>
      <td id="sygnal--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1166">sygnal.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"45Mi"
    ...
    <tr>
      <td id="sygnal--livenessProbe--periodSeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L1170">sygnal.livenessProbe.periodSeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
10
    ...
    <tr>
      <td id="sygnal--livenessProbe--tcpSocket--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1173">sygnal.livenessProbe.tcpSocket.port</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Port des Healthchecks</td>
      <td>
...
"sygnal-port"
    ...
    <tr>
      <td id="sygnal--readinessProbe--periodSeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L1177">sygnal.readinessProbe.periodSeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
10
    ...
    <tr>
      <td id="sygnal--readinessProbe--tcpSocket--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1180">sygnal.readinessProbe.tcpSocket.port</a></div>
      </td>
      <td>string</td>
...
"sygnal-port"
    ...
    <tr>
      <td id="sygnal--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L1183">sygnal.nodeSelector</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="sygnal--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L1186">sygnal.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="sygnal--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L1189">sygnal.affinity</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="sygnal--apps">
        <div style="max-width: 150px;"><a href="../values.yaml#L1197">sygnal.apps</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="sygnal--ioskey_filename">
        <div style="max-width: 150px;"><a href="../values.yaml#L1206">sygnal.ioskey_filename</a></div>
      </td>
      <td>string</td>
      <td>iOS-Key Dateiname Wenn iOS Push mit genutzt wird, muss ein gültiger und valider Dateiname angegeben werden. Bei Nutzung von iOS-Pushservice, muss Key mit angegeben werden. Weiteres siehe ./docs/sygnal_push.md Durch Filename-Vergabe wird der unten angegebene ioskey geladen. Beispiel: ioskey_filename: de.opencode.dvs.ios.p8 <<-- muss zwingend mit dem Keyfile-Dateinamen aus der APNS-Sektion der vorhergehenden Apps-Konfiguration übereinstimmen!</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
""
</pre>
    ...
    <tr>
      <td id="sygnal--ioskey_keyvalue">
        <div style="max-width: 150px;"><a href="../values.yaml#L1210">sygnal.ioskey_keyvalue</a></div>
      </td>
      <td>string</td>
      <td>iOS-Key Datei-Inhalt. Die Zeichenkette muss in Base64 kodiert sein. Beispiel: ioskey_keyvalue: 'HIER KÖNNTE IHR KEY STEHEN'</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
""
</pre>
...
""
    ...
    <tr>
      <td id="sygnal--fcmkey_keyvalue">
        <div style="max-width: 150px;"><a href="../values.yaml#L1222">sygnal.fcmkey_keyvalue</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="wellknown--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1234">wellknown.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="wellknown--server">
        <div style="max-width: 150px;"><a href="../values.yaml#L1239">wellknown.server</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="wellknown--client">
        <div style="max-width: 150px;"><a href="../values.yaml#L1256">wellknown.client</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="wellknown--extraData">
        <div style="max-width: 150px;"><a href="../values.yaml#L1267">wellknown.extraData</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="wellknown--htdocsPath">
        <div style="max-width: 150px;"><a href="../values.yaml#L1271">wellknown.htdocsPath</a></div>
      </td>
      <td>path</td>
...
/usr/share/nginx/html (nginx)
    ...
    <tr>
      <td id="wellknown--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1277">wellknown.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "1.18.0-6ubuntu14.4-jammy-production"
    ...
    <tr>
      <td id="wellknown--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1286">wellknown.podSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="wellknown--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1295">wellknown.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsNonRoot": true
    ...
    <tr>
      <td id="wellknown--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1303">wellknown.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="wellknown--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1305">wellknown.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"50Mi"
    ...
    <tr>
      <td id="wellknown--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1308">wellknown.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="wellknown--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1310">wellknown.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="wellknown--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L1313">wellknown.nodeSelector</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="wellknown--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L1316">wellknown.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="wellknown--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L1319">wellknown.affinity</a></div>
      </td>
      <td>object</td>
  ...
  <tbody>
    <tr>
      <td id="confighub--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1331">confighub.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="confighub--extraData">
        <div style="max-width: 150px;"><a href="../values.yaml#L1336">confighub.extraData</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="confighub--htdocsPath">
        <div style="max-width: 150px;"><a href="../values.yaml#L1340">confighub.htdocsPath</a></div>
      </td>
      <td>path</td>
      <td>Ein benutzerdefinierter htdocs-Pfad, der nützlich ist, wenn ein anderes Image ausgeführt wird.</td>
      <td>
...
/usr/share/nginx/html (nginx)
    ...
    <tr>
      <td id="confighub--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1346">confighub.image</a></div>
      </td>
      <td>map</td>
      <td>Das Webserver Image optional: pullSecrets:   - myRegistryKeySecretName</td>
      <td>
  ...
  "tag": "1.18.0-6ubuntu14.4-jammy-production"
    ...
    <tr>
      <td id="confighub--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1355">confighub.podSecurityContext</a></div>
      </td>
      <td>map</td>
      <td>Informationen zum Sicherheitskontext, die der Pod übernehmen soll. weitere Möglichkeiten:  fsGroup: 1001</td>
      <td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="confighub--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1364">confighub.securityContext</a></div>
      </td>
      <td>map</td>
      <td>Konfiguration für die Container-Sicherheitsrichtlinie weitere Möglichkeiten:  capabilities:    drop:    - ALL</td>
      <td>
  ...
  "runAsNonRoot": true
    ...
    <tr>
      <td id="confighub--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1372">confighub.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="confighub--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1374">confighub.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"50Mi"
    ...
    <tr>
      <td id="confighub--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1377">confighub.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="confighub--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1379">confighub.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="confighub--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L1382">confighub.nodeSelector</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="confighub--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L1385">confighub.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="confighub--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L1388">confighub.affinity</a></div>
      </td>
      <td>object</td>
  ...
  <tbody>
    <tr>
      <td id="postgresql--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1403">postgresql.enabled</a></div>
      </td>
      <td>bool</td>
...
false da externe DB vorausgesetzt wird
    ...
    <tr>
      <td id="postgresql--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1407">postgresql.image</a></div>
      </td>
      <td>map</td>
...
WIRD NICHT EMPFOHLEN!!
    ...
    <tr>
      <td id="postgresql--auth--database">
        <div style="max-width: 150px;"><a href="../values.yaml#L1415">postgresql.auth.database</a></div>
      </td>
      <td>string</td>
...
"synapse_db"
    ...
    <tr>
      <td id="postgresql--auth--username">
        <div style="max-width: 150px;"><a href="../values.yaml#L1418">postgresql.auth.username</a></div>
      </td>
      <td>string</td>
...
"synapse"
    ...
    <tr>
      <td id="postgresql--auth--password">
        <div style="max-width: 150px;"><a href="../values.yaml#L1421">postgresql.auth.password</a></div>
      </td>
      <td>string</td>
...
"synapse"
    ...
    <tr>
      <td id="postgresql--auth--existingSecret">
        <div style="max-width: 150px;"><a href="../values.yaml#L1425">postgresql.auth.existingSecret</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="postgresql--auth--secretKeys--userPasswordKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L1429">postgresql.auth.secretKeys.userPasswordKey</a></div>
      </td>
      <td>string</td>
...
"password"
    ...
    <tr>
      <td id="postgresql--auth--secretKeys--adminPasswordKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L1432">postgresql.auth.secretKeys.adminPasswordKey</a></div>
      </td>
      <td>string</td>
...
"postgres-password"
    ...
    <tr>
      <td id="postgresql--containerPorts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1435">postgresql.containerPorts</a></div>
      </td>
      <td>int</td>
  ...
  "postgresql": 5432
    ...
    <tr>
      <td id="postgresql--primary--initdb--args">
        <div style="max-width: 150px;"><a href="../values.yaml#L1441">postgresql.primary.initdb.args</a></div>
      </td>
      <td>string</td>
...
"--lc-collate=C --lc-ctype=C --encoding=UTF8"
    ...
    <tr>
      <td id="postgresql--primary--extendedConfiguration">
        <div style="max-width: 150px;"><a href="../values.yaml#L1446">postgresql.primary.extendedConfiguration</a></div>
      </td>
      <td>string</td>
...
"max_connections = 1024\n"
    ...
    <tr>
      <td id="postgresql--primary--persistence">
        <div style="max-width: 150px;"><a href="../values.yaml#L1450">postgresql.primary.persistence</a></div>
      </td>
      <td>map</td>
  ...
  "storageClass": ""
    ...
    <tr>
      <td id="postgresql--primary--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1457">postgresql.primary.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
1
    ...
    <tr>
      <td id="postgresql--primary--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1459">postgresql.primary.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"4096Mi"
    ...
    <tr>
      <td id="postgresql--primary--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1462">postgresql.primary.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"250m"
    ...
    <tr>
      <td id="postgresql--primary--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1464">postgresql.primary.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"256Mi"
    ...
    <tr>
      <td id="postgresql--extraArgs">
        <div style="max-width: 150px;"><a href="../values.yaml#L1468">postgresql.extraArgs</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="externalPostgresql">
        <div style="max-width: 150px;"><a href="../values.yaml#L1474">externalPostgresql</a></div>
      </td>
      <td>map</td>
  ...
  "username": "synapse"
    ...
    <tr>
      <td id="externalPostgresql--database">
        <div style="max-width: 150px;"><a href="../values.yaml#L1478">externalPostgresql.database</a></div>
      </td>
      <td>string</td>
...
"synapse_db"
    ...
    <tr>
      <td id="externalPostgresql--username">
        <div style="max-width: 150px;"><a href="../values.yaml#L1481">externalPostgresql.username</a></div>
      </td>
      <td>string</td>
      <td>Name für PostgreSQL Nutzer</td>
      <td>
...
"synapse"
    ...
    <tr>
      <td id="externalPostgresql--password">
        <div style="max-width: 150px;"><a href="../values.yaml#L1484">externalPostgresql.password</a></div>
      </td>
      <td>string</td>
      <td>Passwort für PostgreSQL Nutzer</td>
      <td>
...
"synapse"
    ...
    <tr>
      <td id="externalPostgresql--existingSecret">
        <div style="max-width: 150px;"><a href="../values.yaml#L1487">externalPostgresql.existingSecret</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="externalPostgresql--existingSecretPasswordKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L1490">externalPostgresql.existingSecretPasswordKey</a></div>
      </td>
      <td>string</td>
...
"password"
    ...
    <tr>
      <td id="externalPostgresql--extraArgs">
        <div style="max-width: 150px;"><a href="../values.yaml#L1496">externalPostgresql.extraArgs</a></div>
      </td>
      <td>list</td>
      <td>Zusätzliche Argumente für die Datenbankverbindung ref: https://element-hq.github.io/synapse/latest/postgres.html#synapse-config</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="redis--image--registry">
        <div style="max-width: 150px;"><a href="../values.yaml#L1508">redis.image.registry</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"registry.opencode.de"
    ...
    <tr>
      <td id="redis--image--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L1509">redis.image.repository</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"bwi/bundesmessenger/backend/container-images/redis"
    ...
    <tr>
      <td id="redis--image--tag">
        <div style="max-width: 150px;"><a href="../values.yaml#L1510">redis.image.tag</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"5_6.0.16-1ubuntu1-jammy-production"
    ...
    <tr>
      <td id="redis--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1515">redis.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="redis--auth">
        <div style="max-width: 150px;"><a href="../values.yaml#L1519">redis.auth</a></div>
      </td>
      <td>map</td>
        ...
        <div style="max-width: 300px;"><pre lang="json">
{
  ...
  "password": "synapse"
    ...
    <tr>
      <td id="redis--sysctl">
        <div style="max-width: 150px;"><a href="../values.yaml#L1527">redis.sysctl</a></div>
      </td>
      <td>map</td>
  ...
  "resources": {
    ...
    <tr>
      <td id="redis--architecture">
        <div style="max-width: 150px;"><a href="../values.yaml#L1550">redis.architecture</a></div>
      </td>
      <td>string</td>
...
"standalone"
    ...
    <tr>
      <td id="redis--master--kind">
        <div style="max-width: 150px;"><a href="../values.yaml#L1552">redis.master.kind</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"StatefulSet"
    ...
    <tr>
      <td id="redis--master--persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1557">redis.master.persistence.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="redis--master--service--ports--redis">
        <div style="max-width: 150px;"><a href="../values.yaml#L1561">redis.master.service.ports.redis</a></div>
      </td>
      <td>int</td>
      <td>Serviceport</td>
      <td>
...
6379
    ...
    <tr>
      <td id="redis--master--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1566">redis.master.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="redis--master--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1568">redis.master.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"768Mi"
    ...
    <tr>
      <td id="redis--master--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1571">redis.master.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="redis--master--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1573">redis.master.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"256Mi"
    ...
    <tr>
      <td id="externalRedis">
        <div style="max-width: 150px;"><a href="../values.yaml#L1582">externalRedis</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="ingress--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1601">ingress.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--traefikPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1605">ingress.traefikPaths</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="ingress--annotations">
        <div style="max-width: 150px;"><a href="../values.yaml#L1608">ingress.annotations</a></div>
      </td>
      <td>map</td>
  ...
  "nginx.ingress.kubernetes.io/use-regex": "true"
    ...
    <tr>
      <td id="ingress--annotationsAdminAPI">
        <div style="max-width: 150px;"><a href="../values.yaml#L1627">ingress.annotationsAdminAPI</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="ingress--csHosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1634">ingress.csHosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--hosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1641">ingress.hosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--wkHosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1648">ingress.wkHosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1665">ingress.paths</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1682">ingress.csPaths</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--includeUnderscoreSynapse">
        <div style="max-width: 150px;"><a href="../values.yaml#L1685">ingress.includeUnderscoreSynapse</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--includeServerName">
        <div style="max-width: 150px;"><a href="../values.yaml#L1690">ingress.includeServerName</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--tls">
        <div style="max-width: 150px;"><a href="../values.yaml#L1702">ingress.tls</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--className">
        <div style="max-width: 150px;"><a href="../values.yaml#L1707">ingress.className</a></div>
      </td>
      <td>string</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td id="mas--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1720">mas.enabled</a></div>
      </td>
      <td>boolean</td>
...
false
    ...
    <tr>
      <td id="mas--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1722">mas.image</a></div>
      </td>
      <td>object</td>
        ...
        <div style="max-width: 300px;"><pre lang="json">
{
  ...
  "tag": "0.10.0-debug"
    ...
    <tr>
      <td id="mas--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L1732">mas.uri</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="mas--postgresql">
        <div style="max-width: 150px;"><a href="../values.yaml#L1736">mas.postgresql</a></div>
      </td>
      <td>object</td>
      <td>Zugangsdaten für die benötigte PostreSQL-Datenbank. Diese wird nicht automatisch angelegt und muss bereit gestellt werden. https://matrix-org.github.io/matrix-authentication-service/setup/database.html#set-up-a-database</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
{
  ...
  "username": "massynapse"
    ...
    <tr>
      <td id="mas--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1745">mas.paths</a></div>
      </td>
      <td>list</td>
...
[
  ...
  "/_matrix/client/(api/v1|r0|v3|unstable)/refresh"
    ...
    <tr>
      <td id="mas--masPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1752">mas.masPaths</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="mas--clients">
        <div style="max-width: 150px;"><a href="../values.yaml#L1769">mas.clients</a></div>
      </td>
      <td>list</td>
      <td>OIDC Clients, die zusätzlich zum Synypase Client konfiguriert werden. https://matrix-org.github.io/matrix-authentication-service/reference/configuration.html#clients</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
[]
</pre>
    ...
    <tr>
      <td id="mas--passwords">
        <div style="max-width: 150px;"><a href="../values.yaml#L1773">mas.passwords</a></div>
      </td>
      <td>object</td>
      <td> https://matrix-org.github.io/matrix-authentication-service/reference/configuration.html#passwords</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
{
  "enabled": true,
  "schemes": [
    ...
    <tr>
      <td id="mas--account">
        <div style="max-width: 150px;"><a href="../values.yaml#L1787">mas.account</a></div>
      </td>
      <td>object</td>
      <td> https://matrix-org.github.io/matrix-authentication-service/reference/configuration.html#account</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
{
  ...
  "password_registration_enabled": false
    ...
    <tr>
      <td id="mas--account--email_change_allowed">
        <div style="max-width: 150px;"><a href="../values.yaml#L1789">mas.account.email_change_allowed</a></div>
      </td>
      <td>bool</td>
      <td>Whether users are allowed to change their email addresses. default: true</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
false
</pre>
    ...
    <tr>
      <td id="mas--account--displayname_change_allowed">
        <div style="max-width: 150px;"><a href="../values.yaml#L1793">mas.account.displayname_change_allowed</a></div>
      </td>
      <td>bool</td>
      <td>Whether users are allowed to change their display names. default: true This should be in sync with the policy in the homeserver configuration.</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
false
</pre>
    ...
    <tr>
      <td id="mas--account--password_registration_enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1797">mas.account.password_registration_enabled</a></div>
      </td>
      <td>bool</td>
      <td>Whether to enable self-service password registration. default: false This has no effect if password login is disabled.</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
false
</pre>
    ...
    <tr>
      <td id="mas--account--password_change_allowed">
        <div style="max-width: 150px;"><a href="../values.yaml#L1801">mas.account.password_change_allowed</a></div>
      </td>
      <td>bool</td>
      <td>Whether users are allowed to change their passwords. default: true This has no effect if password login is disabled.</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
true
</pre>
    ...
    <tr>
      <td id="mas--account--password_recovery_enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1805">mas.account.password_recovery_enabled</a></div>
      </td>
      <td>bool</td>
      <td>Whether email-based password recovery is enabled. default: false This has no effect if password login is disabled.</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
false
</pre>
    ...
    <tr>
      <td id="mas--policy">
        <div style="max-width: 150px;"><a href="../values.yaml#L1811">mas.policy</a></div>
      </td>
      <td>object</td>
      <td>Zusätzliche Policy Konfiguration für MAS. Die Angaben werden automatisch in die Konfiguration unter `policy.data` bereit gestellt. https://matrix-org.github.io/matrix-authentication-service/reference/configuration.html#policy</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
{
  "admin_users": [],
  "passwords": {
    ...
    <tr>
      <td id="mas--policy--passwords">
        <div style="max-width: 150px;"><a href="../values.yaml#L1815">mas.policy.passwords</a></div>
      </td>
      <td>object</td>
  ...
  "require_uppercase": true
    ...
    <tr>
      <td id="mas--policy--passwords--min_length">
        <div style="max-width: 150px;"><a href="../values.yaml#L1817">mas.policy.passwords.min_length</a></div>
      </td>
      <td>int</td>
...
8
    ...
    <tr>
      <td id="mas--policy--passwords--require_lowercase">
        <div style="max-width: 150px;"><a href="../values.yaml#L1819">mas.policy.passwords.require_lowercase</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="mas--policy--passwords--require_uppercase">
        <div style="max-width: 150px;"><a href="../values.yaml#L1821">mas.policy.passwords.require_uppercase</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="mas--policy--passwords--require_number">
        <div style="max-width: 150px;"><a href="../values.yaml#L1823">mas.policy.passwords.require_number</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="mas--rate_limiting--account_recovery--per_ip--burst">
        <div style="max-width: 150px;"><a href="../values.yaml#L1836">mas.rate_limiting.account_recovery.per_ip.burst</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
3
    ...
    <tr>
      <td id="mas--rate_limiting--account_recovery--per_ip--per_second">
        <div style="max-width: 150px;"><a href="../values.yaml#L1837">mas.rate_limiting.account_recovery.per_ip.per_second</a></div>
      </td>
      <td>float</td>
      <td></td>
      <td>
...
0.0008
    ...
    <tr>
      <td id="mas--rate_limiting--account_recovery--per_address--burst">
        <div style="max-width: 150px;"><a href="../values.yaml#L1842">mas.rate_limiting.account_recovery.per_address.burst</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
3
    ...
    <tr>
      <td id="mas--rate_limiting--account_recovery--per_address--per_second">
        <div style="max-width: 150px;"><a href="../values.yaml#L1843">mas.rate_limiting.account_recovery.per_address.per_second</a></div>
      </td>
      <td>float</td>
      <td></td>
      <td>
...
0.0002
    ...
    <tr>
      <td id="mas--rate_limiting--login--per_ip--burst">
        <div style="max-width: 150px;"><a href="../values.yaml#L1854">mas.rate_limiting.login.per_ip.burst</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
3
    ...
    <tr>
      <td id="mas--rate_limiting--login--per_ip--per_second">
        <div style="max-width: 150px;"><a href="../values.yaml#L1855">mas.rate_limiting.login.per_ip.per_second</a></div>
      </td>
      <td>float</td>
      <td></td>
      <td>
...
0.05
    ...
    <tr>
      <td id="mas--rate_limiting--login--per_account--burst">
        <div style="max-width: 150px;"><a href="../values.yaml#L1863">mas.rate_limiting.login.per_account.burst</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
1800
    ...
    <tr>
      <td id="mas--rate_limiting--login--per_account--per_second">
        <div style="max-width: 150px;"><a href="../values.yaml#L1864">mas.rate_limiting.login.per_account.per_second</a></div>
      </td>
      <td>float</td>
      <td></td>
      <td>
...
0.5
    ...
    <tr>
      <td id="mas--rate_limiting--registration--burst">
        <div style="max-width: 150px;"><a href="../values.yaml#L1870">mas.rate_limiting.registration.burst</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
3
    ...
    <tr>
      <td id="mas--rate_limiting--registration--per_second">
        <div style="max-width: 150px;"><a href="../values.yaml#L1871">mas.rate_limiting.registration.per_second</a></div>
      </td>
      <td>float</td>
      <td></td>
      <td>
...
0.0008
    ...
    <tr>
      <td id="mas--email">
        <div style="max-width: 150px;"><a href="../values.yaml#L1875">mas.email</a></div>
      </td>
      <td>object</td>
      <td>Zusätzliche E-Mail Konfiguration für MAS. https://matrix-org.github.io/matrix-authentication-service/reference/configuration.html#email</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
{
  "transport": "blackhole"
    ...
    <tr>
      <td id="mas--extraVolumes">
        <div style="max-width: 150px;"><a href="../values.yaml#L1884">mas.extraVolumes</a></div>
      </td>
      <td>list</td>
      <td>Zusätzliche in den MAS zu mountende Datenträger (Volumes) Beispiel:  - name: oauth2    configMap:      name: oauth</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
[]
</pre>
    ...
    <tr>
      <td id="mas--extraVolumeMounts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1892">mas.extraVolumeMounts</a></div>
      </td>
      <td>list</td>
      <td>Zusätzliche in den MAS zu mountende Datenträgerpfade (Volumes) Beispiel:  - name: oauth2    mountPath: /etc/ssl/certs/    subMountPath: oauthprovider.crt    readOnly: true</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
[]
</pre>
    ...
    <tr>
      <td id="mas--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1898">mas.podSecurityContext</a></div>
      </td>
      <td>object</td>
  ...
  "runAsUser": 1007
    ...
    <tr>
      <td id="mas--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1906">mas.securityContext</a></div>
      </td>
      <td>object</td>
      <td>Konfiguration für die Container-Sicherheitsrichtlinie, siehe oben podSecurityContext für weitere relevante Informationen.</td>
      <td>
  ...
  "runAsUser": 1007
    ...
    <tr>
      <td id="mas--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1917">mas.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="mas--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1919">mas.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"200Mi"
    ...
    <tr>
      <td id="mas--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1922">mas.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="mas--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1924">mas.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"50Mi"
    ...
    <tr>
      <td id="mas--livenessProbe--periodSeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L1928">mas.livenessProbe.periodSeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
10
    ...
    <tr>
      <td id="mas--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L1931">mas.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Pfad des Healthchecks</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="mas--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1933">mas.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Port des Healthchecks</td>
      <td>
...
"metrics"
    ...
    <tr>
      <td id="mas--readinessProbe--periodSeconds">
        <div style="max-width: 150px;"><a href="../values.yaml#L1937">mas.readinessProbe.periodSeconds</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
3
    ...
    <tr>
      <td id="mas--readinessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L1940">mas.readinessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Pfads vom Bereitschaftscheck</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="mas--readinessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1942">mas.readinessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Ports vom Bereitschaftscheck</td>
      <td>
...
"metrics"
    ...
    <tr>
      <td id="mas--startupProbe--failureThreshold">
        <div style="max-width: 150px;"><a href="../values.yaml#L1947">mas.startupProbe.failureThreshold</a></div>
      </td>
      <td>int</td>
      <td>Anzahl der Fehlversuche, damit Startzeit für Worker bei 60 Sekunden landet; Timeout default bei 10 Sekunden</td>
      <td>
...
6
    ...
    <tr>
      <td id="mas--startupProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L1951">mas.startupProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Pfads vom Startup-Check DEFAULT gilt für alle Synapse-Worker-Container.</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="mas--startupProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1954">mas.startupProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Ports vom Startup-Check DEFAULT gilt für alle Synapse-Worker-Container.</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="contentscanner--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1964">contentscanner.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="contentscanner--extraVolumes">
        <div style="max-width: 150px;"><a href="../values.yaml#L1975">contentscanner.extraVolumes</a></div>
      </td>
      <td>list</td>
      <td>Zusätzliche in den Matrix-Content-Scanner zu mountende Datenträger (Volumes) Beispiel:  - name: custom-scanscript    configMap:      name: custom-scanscript      defaultMode: 0755      items:      - key: script.sh        path: script.sh</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
[]
</pre>
    ...
    <tr>
      <td id="contentscanner--extraVolumeMounts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1983">contentscanner.extraVolumeMounts</a></div>
      </td>
      <td>list</td>
      <td>Zusätzliche in den Matrix-Content-Scanner zu mountende Datenträgerpfade (Volumes) Beispiel:  - name: custom-scanscript    mountPath: /opt/custom/    subMountPath: script.sh    readOnly: true</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
[]
</pre>
    ...
    <tr>
      <td id="contentscanner--scanScript">
        <div style="max-width: 150px;"><a href="../values.yaml#L1989">contentscanner.scanScript</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"/opt/scanner.sh"
    ...
    <tr>
      <td id="contentscanner--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1992">contentscanner.image</a></div>
      </td>
      <td>map</td>
      <td>Konfiguration des Image/Repository</td>
      <td>
  ...
  "tag": "1.0.6-jammy-production"
    ...
    <tr>
      <td id="contentscanner--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L1998">contentscanner.replicaCount</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
1
    ...
    <tr>
      <td id="contentscanner--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2002">contentscanner.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="contentscanner--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2004">contentscanner.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"1Gi"
    ...
    <tr>
      <td id="contentscanner--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2007">contentscanner.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="contentscanner--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2009">contentscanner.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"500Mi"
    ...
    <tr>
      <td id="contentscanner--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2015">contentscanner.podSecurityContext</a></div>
      </td>
      <td>map</td>
      <td>Informationen zum Sicherheitskontext, die der Pod übernehmen soll. weitere Möglichkeiten:  fsGroup: 1001</td>
      <td>
  ...
  "runAsUser": 1334
    ...
    <tr>
      <td id="contentscanner--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2025">contentscanner.securityContext</a></div>
      </td>
      <td>map</td>
      <td>Konfiguration für die Container-Sicherheitsrichtlinie weitere Möglichkeiten:  capabilities:    drop:    - ALL</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="schadcodescanner--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2036">schadcodescanner.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="schadcodescanner--clamavImage">
        <div style="max-width: 150px;"><a href="../values.yaml#L2038">schadcodescanner.clamavImage</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "0.103.9_dfsg-0ubuntu0.22.04.1-jammy-production"
    ...
    <tr>
      <td id="schadcodescanner--icapImage">
        <div style="max-width: 150px;"><a href="../values.yaml#L2044">schadcodescanner.icapImage</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "1_0.5.6-2build1-jammy-production"
    ...
    <tr>
      <td id="schadcodescanner--persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2052">schadcodescanner.persistence.enabled</a></div>
      </td>
      <td>bool</td>
      <td></td>
      <td>
...
true
    ...
    <tr>
      <td id="schadcodescanner--persistence--existingClaim">
        <div style="max-width: 150px;"><a href="../values.yaml#L2055">schadcodescanner.persistence.existingClaim</a></div>
      </td>
      <td>string</td>
      <td>Name des VolumeClaims</td>
      <td>
...
leer, damit dynamische Volumes genutzt werden können (dennoch persistent)
    ...
    <tr>
      <td id="schadcodescanner--persistence--storageClass">
        <div style="max-width: 150px;"><a href="../values.yaml#L2057">schadcodescanner.persistence.storageClass</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="schadcodescanner--persistence--accessMode">
        <div style="max-width: 150px;"><a href="../values.yaml#L2059">schadcodescanner.persistence.accessMode</a></div>
      </td>
      <td>string</td>
...
"ReadWriteOnce"
    ...
    <tr>
      <td id="schadcodescanner--persistence--size">
        <div style="max-width: 150px;"><a href="../values.yaml#L2061">schadcodescanner.persistence.size</a></div>
      </td>
      <td>string</td>
      <td>Größe des zu nutzenden Volumes</td>
      <td>
...
"10Gi"
    ...
    <tr>
      <td id="schadcodescanner--extraEnv">
        <div style="max-width: 150px;"><a href="../values.yaml#L2071">schadcodescanner.extraEnv</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="schadcodescanner--service--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L2075">schadcodescanner.service.port</a></div>
      </td>
      <td>int</td>
...
1344
    ...
    <tr>
      <td id="schadcodescanner--freshclam--mirrors">
        <div style="max-width: 150px;"><a href="../values.yaml#L2085">schadcodescanner.freshclam.mirrors</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="schadcodescanner--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L2090">schadcodescanner.replicaCount</a></div>
      </td>
      <td>int</td>
...
1
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2097">schadcodescanner.autoscaling.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--minReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L2099">schadcodescanner.autoscaling.minReplicas</a></div>
      </td>
      <td>int</td>
      <td>minimale Anzahl der Worker-Container</td>
      <td>
...
1
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--maxReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L2101">schadcodescanner.autoscaling.maxReplicas</a></div>
      </td>
      <td>int</td>
      <td>maximale Anzahl der Worker-Container</td>
      <td>
...
4
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--targetCPUUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L2103">schadcodescanner.autoscaling.targetCPUUtilizationPercentage</a></div>
      </td>
      <td>int</td>
      <td>Prozentsatz für CPU-Auslastung um Scaling zu triggern</td>
      <td>
...
90
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--targetMemoryUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L2105">schadcodescanner.autoscaling.targetMemoryUtilizationPercentage</a></div>
      </td>
      <td>int</td>
      <td>Prozentsatz für RAM-Auslastung um Scaling zu triggern</td>
      <td>
...
80
    ...
    <tr>
      <td id="schadcodescanner--limits--fileSize">
        <div style="max-width: 150px;"><a href="../values.yaml#L2109">schadcodescanner.limits.fileSize</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
50
    ...
    <tr>
      <td id="schadcodescanner--limits--scanSize">
        <div style="max-width: 150px;"><a href="../values.yaml#L2111">schadcodescanner.limits.scanSize</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
100
    ...
    <tr>
      <td id="schadcodescanner--limits--connectionQueueLength">
        <div style="max-width: 150px;"><a href="../values.yaml#L2113">schadcodescanner.limits.connectionQueueLength</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
100
    ...
    <tr>
      <td id="schadcodescanner--limits--maxThreads">
        <div style="max-width: 150px;"><a href="../values.yaml#L2115">schadcodescanner.limits.maxThreads</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
4
    ...
    <tr>
      <td id="schadcodescanner--limits--sendBufTimeout">
        <div style="max-width: 150px;"><a href="../values.yaml#L2117">schadcodescanner.limits.sendBufTimeout</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
500
    ...
    <tr>
      <td id="schadcodescanner--resourcesClamav--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2122">schadcodescanner.resourcesClamav.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"1500m"
    ...
    <tr>
      <td id="schadcodescanner--resourcesClamav--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2124">schadcodescanner.resourcesClamav.limits.memory</a></div>
      </td>
      <td>string</td>
...
"4Gi"
    ...
    <tr>
      <td id="schadcodescanner--resourcesClamav--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2127">schadcodescanner.resourcesClamav.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="schadcodescanner--resourcesClamav--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2129">schadcodescanner.resourcesClamav.requests.memory</a></div>
      </td>
      <td>string</td>
...
"2Gi"
    ...
    <tr>
      <td id="schadcodescanner--resourcesCicap--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2134">schadcodescanner.resourcesCicap.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="schadcodescanner--resourcesCicap--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2136">schadcodescanner.resourcesCicap.limits.memory</a></div>
      </td>
      <td>string</td>
...
"100Mi"
    ...
    <tr>
      <td id="schadcodescanner--resourcesCicap--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2139">schadcodescanner.resourcesCicap.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="schadcodescanner--resourcesCicap--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2141">schadcodescanner.resourcesCicap.requests.memory</a></div>
      </td>
      <td>string</td>
...
"50Mi"
    ...
    <tr>
      <td id="schadcodescanner--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2144">schadcodescanner.podSecurityContext</a></div>
      </td>
      <td>map</td>
      <td>Informationen zum Sicherheitskontext, die der Pod übernehmen soll.</td>
      <td>
  ...
  "runAsNonRoot": true
    ...
    <tr>
      <td id="schadcodescanner--clamavSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2153">schadcodescanner.clamavSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 1111
    ...
    <tr>
      <td id="schadcodescanner--icapSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2163">schadcodescanner.icapSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="synapse_admin--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2175">synapse_admin.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="synapse_admin--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L2177">synapse_admin.uri</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="synapse_admin--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L2179">synapse_admin.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "0.9.1-jammy-production"
    ...
    <tr>
      <td id="synapse_admin--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2189">synapse_admin.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="synapse_admin--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2191">synapse_admin.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"50Mi"
    ...
    <tr>
      <td id="synapse_admin--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2194">synapse_admin.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="synapse_admin--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2196">synapse_admin.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="synapse_admin--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2202">synapse_admin.podSecurityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="synapse_admin--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2210">synapse_admin.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="webclient--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2245">webclient.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="webclient--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L2247">webclient.uri</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="webclient--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L2249">webclient.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "2.18.0-jammy-production"
    ...
    <tr>
      <td id="webclient--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2258">webclient.podSecurityContext</a></div>
      </td>
      <td>map</td>
      <td>Informationen zum Sicherheitskontext, die der Pod übernehmen soll. weitere Möglichkeiten:  fsGroup: 1001</td>
      <td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="webclient--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2267">webclient.securityContext</a></div>
      </td>
      <td>map</td>
      <td>Konfiguration für die Container-Sicherheitsrichtlinie weitere Möglichkeiten:  capabilities:    drop:    - ALL</td>
      <td>
  ...
  "runAsNonRoot": true
    ...
    <tr>
      <td id="webclient--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2275">webclient.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"150m"
    ...
    <tr>
      <td id="webclient--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2277">webclient.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"100Mi"
    ...
    <tr>
      <td id="webclient--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2280">webclient.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="webclient--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2282">webclient.resources.requests.memory</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="additionalConfig--verifyJWT">
        <div style="max-width: 150px;"><a href="../values.yaml#L2299">additionalConfig.verifyJWT</a></div>
      </td>
      <td>list</td>
      <td>Liste an JWT, die dem Client bereit gestellt werden, um die Infrastruktur als legitim auszuweisen. Diese werden via `<public_baseurl>/_bum/configure/v1/verify`</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
[]
</pre>
    ...
    <tr>
      <td id="additionalConfig--dsgvoExport--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2304">additionalConfig.dsgvoExport.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="additionalConfig--dsgvoExport--serviceAccount--create">
        <div style="max-width: 150px;"><a href="../values.yaml#L2307">additionalConfig.dsgvoExport.serviceAccount.create</a></div>
      </td>
      <td>bool</td>
      <td></td>
      <td>
...
true
    ...
    <tr>
      <td id="additionalConfig--locationSharing--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2316">additionalConfig.locationSharing.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="additionalConfig--locationSharing--map_style_url">
        <div style="max-width: 150px;"><a href="../values.yaml#L2322">additionalConfig.locationSharing.map_style_url</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="additionalConfig--locationSharing--map_style_config">
        <div style="max-width: 150px;"><a href="../values.yaml#L2328">additionalConfig.locationSharing.map_style_config</a></div>
      </td>
      <td>object</td>
  ...
  "version": 8
    ...
    <tr>
      <td id="additionalConfig--maintenance">
        <div style="max-width: 150px;"><a href="../values.yaml#L2386">additionalConfig.maintenance</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="networkpolicies--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2394">networkpolicies.enabled</a></div>
      </td>
      <td>bool</td>
      <td></td>
      <td>
...
false
    ...
    <tr>
      <td id="networkpolicies--fwProxyList">
        <div style="max-width: 150px;"><a href="../values.yaml#L2401">networkpolicies.fwProxyList</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="networkpolicies--egressIpBlock">
        <div style="max-width: 150px;"><a href="../values.yaml#L2407">networkpolicies.egressIpBlock</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="networkpolicies--dnsLabel">
        <div style="max-width: 150px;"><a href="../values.yaml#L2409">networkpolicies.dnsLabel</a></div>
      </td>
      <td>string</td>
...
"kube-dns"
    ...
    <tr>
      <td id="networkpolicies--ingressNamespace">
        <div style="max-width: 150px;"><a href="../values.yaml#L2413">networkpolicies.ingressNamespace</a></div>
      </td>
      <td>string</td>
...
"default"
    ...
    <tr>
      <td id="networkpolicies--postgres--externalPostgresIP">
        <div style="max-width: 150px;"><a href="../values.yaml#L2419">networkpolicies.postgres.externalPostgresIP</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
""
    ...
    <tr>
      <td id="networkpolicies--postgres--labelselector">
        <div style="max-width: 150px;"><a href="../values.yaml#L2423">networkpolicies.postgres.labelselector</a></div>
      </td>
      <td>string</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td id="tests--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L2432">tests.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "1.21.2-jammy-production"
    ...
    <tr>
      <td id="tests--annotations">
        <div style="max-width: 150px;"><a href="../values.yaml#L2439">tests.annotations</a></div>
      </td>
      <td>map</td>
  ...
  "helm.sh/hook-delete-policy": "before-hook-creation,hook-succeeded"
    ...
    <tr>
      <td id="tests--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2443">tests.podSecurityContext</a></div>
      </td>
      <td>map</td>
      <td>Informationen zum Sicherheitskontext, die der Pod übernehmen soll.</td>
      <td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="tests--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L2448">tests.securityContext</a></div>
      </td>
      <td>map</td>
      <td>Konfiguration für die Container-Sicherheitsrichtlinie</td>
      <td>
  ...
  "runAsUser": 1001
    ...
    <tr>
      <td id="tests--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2458">tests.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"100m"
    ...
    <tr>
      <td id="tests--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2460">tests.resources.limits.memory</a></div>
      </td>
      <td>string</td>
...
"32Mi"
    ...
    <tr>
      <td id="tests--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L2463">tests.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="tests--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L2465">tests.resources.requests.memory</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="demomode--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L2475">demomode.enabled</a></div>
      </td>
      <td>boolean</td>
...
false
    ...
    <tr>
      <td id="demomode--serviceAccount--create">
        <div style="max-width: 150px;"><a href="../values.yaml#L2478">demomode.serviceAccount.create</a></div>
      </td>
      <td>bool</td>
      <td></td>
      <td>
...
true
    ...
    <tr>
      <td id="demomode--mode">
        <div style="max-width: 150px;"><a href="../values.yaml#L2488">demomode.mode</a></div>
      </td>
      <td>string</td>
...
"complete"
    ...
    <tr>
      <td id="demomode--interval">
        <div style="max-width: 150px;"><a href="../values.yaml#L2509">demomode.interval</a></div>
      </td>
      <td>string</td>
...
"0 0 * * 0"
    ...
    <tr>
      <td id="demomode--existingClaim">
        <div style="max-width: 150px;"><a href="../values.yaml#L2512">demomode.existingClaim</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="demomode--postgresqldump">
        <div style="max-width: 150px;"><a href="../values.yaml#L2518">demomode.postgresqldump</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="demomode--sqldump">
        <div style="max-width: 150px;"><a href="../values.yaml#L2521">demomode.sqldump</a></div>
      </td>
      <td>string</td>
