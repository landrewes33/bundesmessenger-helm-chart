...
"registry.opencode.de/bwi/bundesmessenger/backend/container-images/jammy-synapse-production"
    ...
    <tr>
      <td id="image--tag">
        <div style="max-width: 150px;"><a href="../values.yaml#L12">image.tag</a></div>
      </td>
      <td>string</td>
      <td>kann die gesetzte Defaultversion überschreiben, wenn gesetzt.</td>
      <td>
        <div style="max-width: 300px;"><pre lang="">
wird im Charts.yaml gesetzt
</pre>
</div>
      </td>
    </tr>
    <tr>
      <td id="image--pullSecrets">
        <div style="max-width: 150px;"><a href="../values.yaml#L20">image.pullSecrets</a></div>
      </td>
      <td>map</td>
...
nicht gesetzt
    ...
    <tr>
      <td id="image--pullPolicy">
        <div style="max-width: 150px;"><a href="../values.yaml#L24">image.pullPolicy</a></div>
      </td>
      <td>string</td>
...
"IfNotPresent"
    ...
    <tr>
      <td id="image--nameOverride">
        <div style="max-width: 150px;"><a href="../values.yaml#L27">image.nameOverride</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="image--fullnameOverride">
        <div style="max-width: 150px;"><a href="../values.yaml#L30">image.fullnameOverride</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="serverName">
        <div style="max-width: 150px;"><a href="../values.yaml#L35">serverName</a></div>
      </td>
      <td>string</td>
...
Nicht gesetzt, aber Voraussetzung!
    ...
    <tr>
      <td id="publicServerName">
        <div style="max-width: 150px;"><a href="../values.yaml#L40">publicServerName</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="monitoringService">
        <div style="max-width: 150px;"><a href="../values.yaml#L44">monitoringService</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="displayName">
        <div style="max-width: 150px;"><a href="../values.yaml#L48">displayName</a></div>
      </td>
      <td>string</td>
...
Messenger deiner Organisation
    ...
    <tr>
      <td id="signingkey--job--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L66">signingkey.job.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="signingkey--job--generateImage--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L73">signingkey.job.generateImage.repository</a></div>
      </td>
      <td>string</td>
      <td>Repository/Image Konfiguration für Synapse-signing-key-job. Es wird dringend empfohlen, dass die gleiche Konfiguration wie vom Synapse bzw. den Workernodes genutzt wird. ursprünglich: "repository: matrixdotorg/synapse" bei Nichtsetzen vom Tag, wird das Tag aus dem Chart.yaml übernommen</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
"registry.opencode.de/bwi/bundesmessenger/backend/container-images/jammy-synapse-production"
</pre>
    ...
    <tr>
      <td id="signingkey--job--generateImage--pullSecrets">
        <div style="max-width: 150px;"><a href="../values.yaml#L74">signingkey.job.generateImage.pullSecrets</a></div>
      </td>
      <td>list</td>
      <td></td>
      <td>
...
[]
    ...
    <tr>
      <td id="signingkey--job--generateImage--pullPolicy">
        <div style="max-width: 150px;"><a href="../values.yaml#L78">signingkey.job.generateImage.pullPolicy</a></div>
      </td>
      <td>string</td>
...
"IfNotPresent"
    ...
    <tr>
      <td id="signingkey--job--publishImage">
        <div style="max-width: 150px;"><a href="../values.yaml#L81">signingkey.job.publishImage</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "1.21.14"
    ...
    <tr>
      <td id="signingkey--resources">
        <div style="max-width: 150px;"><a href="../values.yaml#L91">signingkey.resources</a></div>
      </td>
      <td>object</td>
      <td></td>
      <td>
...
{}
    ...
    <tr>
      <td id="ipv4Only">
        <div style="max-width: 150px;"><a href="../values.yaml#L105">ipv4Only</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="config--logLevel">
        <div style="max-width: 150px;"><a href="../values.yaml#L119">config.logLevel</a></div>
      </td>
      <td>string</td>
...
"INFO"
    ...
    <tr>
      <td id="config--reportStats">
        <div style="max-width: 150px;"><a href="../values.yaml#L122">config.reportStats</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="config--turnUris">
        <div style="max-width: 150px;"><a href="../values.yaml#L133">config.turnUris</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="config--enableRegistration">
        <div style="max-width: 150px;"><a href="../values.yaml#L140">config.enableRegistration</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="config--registrationSharedSecret">
        <div style="max-width: 150px;"><a href="../values.yaml#L143">config.registrationSharedSecret</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="config--macaroonSecretKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L146">config.macaroonSecretKey</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="config--trustedKeyServers">
        <div style="max-width: 150px;"><a href="../values.yaml#L150">config.trustedKeyServers</a></div>
      </td>
      <td>map</td>
...
[
  {
    ...
    <tr>
      <td id="config--extraListeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L156">config.extraListeners</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="extraConfig">
        <div style="max-width: 150px;"><a href="../values.yaml#L164">extraConfig</a></div>
      </td>
      <td>object</td>
...
wird nachfolgend aufgeschlüsselt
    ...
    <tr>
      <td id="extraConfig--require_auth_for_profile_requests">
        <div style="max-width: 150px;"><a href="../values.yaml#L168">extraConfig.require_auth_for_profile_requests</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--limit_profile_requests_to_users_who_share_rooms">
        <div style="max-width: 150px;"><a href="../values.yaml#L170">extraConfig.limit_profile_requests_to_users_who_share_rooms</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--include_profile_data_on_invite">
        <div style="max-width: 150px;"><a href="../values.yaml#L172">extraConfig.include_profile_data_on_invite</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--allow_public_rooms_without_auth">
        <div style="max-width: 150px;"><a href="../values.yaml#L174">extraConfig.allow_public_rooms_without_auth</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--allow_public_rooms_over_federation">
        <div style="max-width: 150px;"><a href="../values.yaml#L176">extraConfig.allow_public_rooms_over_federation</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--block_non_admin_invites">
        <div style="max-width: 150px;"><a href="../values.yaml#L178">extraConfig.block_non_admin_invites</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--ip_range_whitelist">
        <div style="max-width: 150px;"><a href="../values.yaml#L180">extraConfig.ip_range_whitelist</a></div>
      </td>
      <td>list</td>
  ...
  "192.168.0.0/16"
    ...
    <tr>
      <td id="extraConfig--presence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L183">extraConfig.presence.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--enable_search">
        <div style="max-width: 150px;"><a href="../values.yaml#L185">extraConfig.enable_search</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--user_directory--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L188">extraConfig.user_directory.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--user_directory--search_all_users">
        <div style="max-width: 150px;"><a href="../values.yaml#L190">extraConfig.user_directory.search_all_users</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--require_membership_for_aliases">
        <div style="max-width: 150px;"><a href="../values.yaml#L192">extraConfig.require_membership_for_aliases</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--user_ips_max_age">
        <div style="max-width: 150px;"><a href="../values.yaml#L194">extraConfig.user_ips_max_age</a></div>
      </td>
      <td>string</td>
...
"28d"
    ...
    <tr>
      <td id="extraConfig--retention--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L197">extraConfig.retention.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--url_preview_enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L199">extraConfig.url_preview_enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--oembed--disable_default_providers">
        <div style="max-width: 150px;"><a href="../values.yaml#L202">extraConfig.oembed.disable_default_providers</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--enable_3pid_lookup">
        <div style="max-width: 150px;"><a href="../values.yaml#L204">extraConfig.enable_3pid_lookup</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--allow_guest_access">
        <div style="max-width: 150px;"><a href="../values.yaml#L206">extraConfig.allow_guest_access</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--enable_metrics">
        <div style="max-width: 150px;"><a href="../values.yaml#L208">extraConfig.enable_metrics</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--report_stats">
        <div style="max-width: 150px;"><a href="../values.yaml#L210">extraConfig.report_stats</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--password_config">
        <div style="max-width: 150px;"><a href="../values.yaml#L213">extraConfig.password_config</a></div>
      </td>
      <td>object</td>
...
folgende Aufschlüsselung
    ...
    <tr>
      <td id="extraConfig--password_config--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L215">extraConfig.password_config.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--localdb_enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L217">extraConfig.password_config.localdb_enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L220">extraConfig.password_config.policy.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--minimum_length">
        <div style="max-width: 150px;"><a href="../values.yaml#L222">extraConfig.password_config.policy.minimum_length</a></div>
      </td>
      <td>int</td>
...
8
    ...
    <tr>
      <td id="extraConfig--password_config--policy--require_digit">
        <div style="max-width: 150px;"><a href="../values.yaml#L224">extraConfig.password_config.policy.require_digit</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--require_symbol">
        <div style="max-width: 150px;"><a href="../values.yaml#L226">extraConfig.password_config.policy.require_symbol</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--require_lowercase">
        <div style="max-width: 150px;"><a href="../values.yaml#L228">extraConfig.password_config.policy.require_lowercase</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--password_config--policy--require_uppercase">
        <div style="max-width: 150px;"><a href="../values.yaml#L230">extraConfig.password_config.policy.require_uppercase</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--ui_auth--session_timeout">
        <div style="max-width: 150px;"><a href="../values.yaml#L233">extraConfig.ui_auth.session_timeout</a></div>
      </td>
      <td>string</td>
...
"15s"
    ...
    <tr>
      <td id="extraConfig--push--include_content">
        <div style="max-width: 150px;"><a href="../values.yaml#L236">extraConfig.push.include_content</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--encryption_enabled_by_default_for_room_type">
        <div style="max-width: 150px;"><a href="../values.yaml#L238">extraConfig.encryption_enabled_by_default_for_room_type</a></div>
      </td>
      <td>string</td>
...
"all"
    ...
    <tr>
      <td id="extraConfig--stats--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L241">extraConfig.stats.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--enable_room_list_search">
        <div style="max-width: 150px;"><a href="../values.yaml#L243">extraConfig.enable_room_list_search</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraConfig--opentracing--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L249">extraConfig.opentracing.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="extraConfig--federation_domain_whitelist">
        <div style="max-width: 150px;"><a href="../values.yaml#L251">extraConfig.federation_domain_whitelist</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="extraConfig--dynamic_thumbnails">
        <div style="max-width: 150px;"><a href="../values.yaml#L256">extraConfig.dynamic_thumbnails</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="extraSecrets">
        <div style="max-width: 150px;"><a href="../values.yaml#L264">extraSecrets</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="synapse">
        <div style="max-width: 150px;"><a href="../values.yaml#L268">synapse</a></div>
      </td>
      <td>object</td>
...
wird nachfolgend einzeln aufgeschlüsselt
    ...
    <tr>
      <td id="synapse--strategy--type">
        <div style="max-width: 150px;"><a href="../values.yaml#L275">synapse.strategy.type</a></div>
      </td>
      <td>string</td>
...
"RollingUpdate"
    ...
    <tr>
      <td id="synapse--annotations">
        <div style="max-width: 150px;"><a href="../values.yaml#L282">synapse.annotations</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="synapse--labels">
        <div style="max-width: 150px;"><a href="../values.yaml#L285">synapse.labels</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="synapse--extraEnv">
        <div style="max-width: 150px;"><a href="../values.yaml#L293">synapse.extraEnv</a></div>
      </td>
      <td>map</td>
...
[]
    ...
    <tr>
      <td id="synapse--extraVolumes">
        <div style="max-width: 150px;"><a href="../values.yaml#L304">synapse.extraVolumes</a></div>
      </td>
      <td>object</td>
...
[]
    ...
    <tr>
      <td id="synapse--extraVolumeMounts">
        <div style="max-width: 150px;"><a href="../values.yaml#L310">synapse.extraVolumeMounts</a></div>
      </td>
      <td>object</td>
...
[]
    ...
    <tr>
      <td id="synapse--extraCommands">
        <div style="max-width: 150px;"><a href="../values.yaml#L316">synapse.extraCommands</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="synapse--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L322">synapse.podSecurityContext</a></div>
      </td>
      <td>object</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="synapse--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L330">synapse.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="synapse--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L352">synapse.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"1000m"
    ...
    <tr>
      <td id="synapse--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L354">synapse.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"2500Mi"
    ...
    <tr>
      <td id="synapse--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L357">synapse.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"1000m"
    ...
    <tr>
      <td id="synapse--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L359">synapse.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"2500Mi"
    ...
    <tr>
      <td id="synapse--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L365">synapse.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="synapse--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L367">synapse.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="synapse--readinessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L373">synapse.readinessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="synapse--readinessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L375">synapse.readinessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="synapse--startupProbe--failureThreshold">
        <div style="max-width: 150px;"><a href="../values.yaml#L380">synapse.startupProbe.failureThreshold</a></div>
      </td>
      <td>int</td>
...
6
    ...
    <tr>
      <td id="synapse--startupProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L384">synapse.startupProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="synapse--startupProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L387">synapse.startupProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="synapse--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L391">synapse.nodeSelector</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="synapse--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L418">synapse.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="synapse--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L421">synapse.affinity</a></div>
      </td>
      <td>object</td>
...
{}
    ...
    <tr>
      <td id="workers--annotations">
        <div style="max-width: 150px;"><a href="../values.yaml#L437">workers.annotations</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="workers--default--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L443">workers.default.replicaCount</a></div>
      </td>
      <td>int</td>
...
1
    ...
    <tr>
      <td id="workers--default--strategy--type">
        <div style="max-width: 150px;"><a href="../values.yaml#L451">workers.default.strategy.type</a></div>
      </td>
      <td>string</td>
...
"RollingUpdate"
    ...
    <tr>
      <td id="workers--default--annotations">
        <div style="max-width: 150px;"><a href="../values.yaml#L466">workers.default.annotations</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="workers--default--extraEnv">
        <div style="max-width: 150px;"><a href="../values.yaml#L474">workers.default.extraEnv</a></div>
      </td>
      <td>object</td>
...
[]
    ...
    <tr>
      <td id="workers--default--volumes">
        <div style="max-width: 150px;"><a href="../values.yaml#L480">workers.default.volumes</a></div>
      </td>
      <td>map</td>
...
[]
    ...
    <tr>
      <td id="workers--default--volumeMounts">
        <div style="max-width: 150px;"><a href="../values.yaml#L484">workers.default.volumeMounts</a></div>
      </td>
      <td>map</td>
...
[]
    ...
    <tr>
      <td id="workers--default--extraCommands">
        <div style="max-width: 150px;"><a href="../values.yaml#L491">workers.default.extraCommands</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="workers--default--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L499">workers.default.podSecurityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="workers--default--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L510">workers.default.securityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="workers--default--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L517">workers.default.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"100m"
    ...
    <tr>
      <td id="workers--default--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L521">workers.default.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"128Mi"
    ...
    <tr>
      <td id="workers--default--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L526">workers.default.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"100m"
    ...
    <tr>
      <td id="workers--default--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L530">workers.default.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"128Mi"
    ...
    <tr>
      <td id="workers--default--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L537">workers.default.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="workers--default--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L540">workers.default.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="workers--default--readinessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L547">workers.default.readinessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
...
"/health"
    ...
    <tr>
      <td id="workers--default--readinessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L550">workers.default.readinessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
...
"metrics"
    ...
    <tr>
      <td id="workers--default--startupProbe--failureThreshold">
        <div style="max-width: 150px;"><a href="../values.yaml#L555">workers.default.startupProbe.failureThreshold</a></div>
      </td>
      <td>int</td>
      <td>Anzahl der Fehlversuche, damit Startzeit für Worker bei 60 Sekunden landet; Timeout default bei 10 Sekunden</td>
      <td>
...
6
    ...
    <tr>
      <td id="workers--default--startupProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L559">workers.default.startupProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Pfads vom Startup-Check DEFAULT gilt für alle Synapse-Worker-Container.</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="workers--default--startupProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L562">workers.default.startupProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Ports vom Startup-Check DEFAULT gilt für alle Synapse-Worker-Container.</td>
      <td>
...
"metrics"
    ...
    <tr>
      <td id="workers--default--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L566">workers.default.nodeSelector</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="workers--default--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L570">workers.default.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="workers--default--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L574">workers.default.affinity</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="workers--generic_worker--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L583">workers.generic_worker.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="workers--generic_worker--generic">
        <div style="max-width: 150px;"><a href="../values.yaml#L587">workers.generic_worker.generic</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="workers--generic_worker--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L589">workers.generic_worker.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 2003
    ...
    <tr>
      <td id="workers--generic_worker--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L594">workers.generic_worker.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "federation"
    ...
    <tr>
      <td id="workers--generic_worker--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L597">workers.generic_worker.csPaths</a></div>
      </td>
      <td>path</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--generic_worker--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L667">workers.generic_worker.paths</a></div>
      </td>
      <td>path</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--generic_worker--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L693">workers.generic_worker.replicaCount</a></div>
      </td>
      <td>int</td>
...
2
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L700">workers.generic_worker.autoscaling.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--minReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L702">workers.generic_worker.autoscaling.minReplicas</a></div>
      </td>
      <td>int</td>
...
2
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--maxReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L704">workers.generic_worker.autoscaling.maxReplicas</a></div>
      </td>
      <td>int</td>
...
10
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--targetCPUUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L706">workers.generic_worker.autoscaling.targetCPUUtilizationPercentage</a></div>
      </td>
      <td>int</td>
...
80
    ...
    <tr>
      <td id="workers--generic_worker--autoscaling--targetMemoryUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L708">workers.generic_worker.autoscaling.targetMemoryUtilizationPercentage</a></div>
      </td>
      <td>int</td>
...
80
    ...
    <tr>
      <td id="workers--federation_reader--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L717">workers.federation_reader.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--federation_reader--generic">
        <div style="max-width: 150px;"><a href="../values.yaml#L719">workers.federation_reader.generic</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="workers--federation_reader--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L721">workers.federation_reader.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "federation"
    ...
    <tr>
      <td id="workers--federation_reader--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L724">workers.federation_reader.paths</a></div>
      </td>
      <td>path</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--pusher--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L732">workers.pusher.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--appservice--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L737">workers.appservice.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--federation_sender--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L744">workers.federation_sender.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--media_repository--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L750">workers.media_repository.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="workers--media_repository--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L753">workers.media_repository.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  "runAsUser": 2666
    ...
    <tr>
      <td id="workers--media_repository--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L758">workers.media_repository.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "media"
    ...
    <tr>
      <td id="workers--media_repository--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L761">workers.media_repository.csPaths</a></div>
      </td>
      <td>path</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--media_repository--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L770">workers.media_repository.paths</a></div>
      </td>
      <td>path</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="workers--media_repository--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L775">workers.media_repository.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"2000m"
    ...
    <tr>
      <td id="workers--media_repository--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L777">workers.media_repository.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"3500Mi"
    ...
    <tr>
      <td id="workers--media_repository--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L780">workers.media_repository.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"1000m"
    ...
    <tr>
      <td id="workers--media_repository--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L782">workers.media_repository.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"2500Mi"
    ...
    <tr>
      <td id="workers--user_dir--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L790">workers.user_dir.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="workers--user_dir--name">
        <div style="max-width: 150px;"><a href="../values.yaml#L792">workers.user_dir.name</a></div>
      </td>
      <td>string</td>
...
"user_directory_worker"
    ...
    <tr>
      <td id="workers--user_dir--generic">
        <div style="max-width: 150px;"><a href="../values.yaml#L794">workers.user_dir.generic</a></div>
      </td>
      <td>bool</td>
      <td>Wird aus dem generischen Worker abgeleitet</td>
      <td>
...
true
    ...
    <tr>
      <td id="workers--user_dir--listeners">
        <div style="max-width: 150px;"><a href="../values.yaml#L796">workers.user_dir.listeners</a></div>
      </td>
      <td>list</td>
  ...
  "client"
    ...
    <tr>
      <td id="workers--user_dir--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L799">workers.user_dir.csPaths</a></div>
      </td>
      <td>path</td>
...
werden in der values.yaml gesetzt und können dort eingesehen werden
    ...
    <tr>
      <td id="persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L807">persistence.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="persistence--existingClaim">
        <div style="max-width: 150px;"><a href="../values.yaml#L810">persistence.existingClaim</a></div>
      </td>
      <td>string</td>
...
leerer Wert lässt dynamisches Provisionieren zu
    ...
    <tr>
      <td id="persistence--storageClass">
        <div style="max-width: 150px;"><a href="../values.yaml#L812">persistence.storageClass</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="persistence--accessMode">
        <div style="max-width: 150px;"><a href="../values.yaml#L814">persistence.accessMode</a></div>
      </td>
      <td>string</td>
      <td>Zugriffsmodus</td>
      <td>
...
"ReadWriteOnce"
    ...
    <tr>
      <td id="persistence--size">
        <div style="max-width: 150px;"><a href="../values.yaml#L816">persistence.size</a></div>
      </td>
      <td>string</td>
...
"10Gi"
    ...
    <tr>
      <td id="volumePermissions--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L822">volumePermissions.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="volumePermissions--uid">
        <div style="max-width: 150px;"><a href="../values.yaml#L825">volumePermissions.uid</a></div>
      </td>
      <td>int</td>
...
2666
    ...
    <tr>
      <td id="volumePermissions--gid">
        <div style="max-width: 150px;"><a href="../values.yaml#L828">volumePermissions.gid</a></div>
      </td>
      <td>int</td>
      <td>Nutzer-ID Notwendig für policy 'require-uid-greater-2000'</td>
      <td>
...
2666
    ...
    <tr>
      <td id="volumePermissions--image--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L832">volumePermissions.image.repository</a></div>
      </td>
      <td>string</td>
...
"registry.opencode.de/bwi/bundesmessenger/backend/container-images/jammy-base-production"
    ...
    <tr>
      <td id="volumePermissions--image--tag">
        <div style="max-width: 150px;"><a href="../values.yaml#L835">volumePermissions.image.tag</a></div>
      </td>
      <td>string</td>
...
"b10"
    ...
    <tr>
      <td id="volumePermissions--image--pullPolicy">
        <div style="max-width: 150px;"><a href="../values.yaml#L837">volumePermissions.image.pullPolicy</a></div>
      </td>
      <td>string</td>
...
"IfNotPresent"
    ...
    <tr>
      <td id="volumePermissions--resources">
        <div style="max-width: 150px;"><a href="../values.yaml#L846">volumePermissions.resources</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="service--type">
        <div style="max-width: 150px;"><a href="../values.yaml#L854">service.type</a></div>
      </td>
      <td>string</td>
...
"ClusterIP"
    ...
    <tr>
      <td id="service--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L856">service.port</a></div>
      </td>
      <td>int</td>
...
8008
    ...
    <tr>
      <td id="service--targetPort">
        <div style="max-width: 150px;"><a href="../values.yaml#L858">service.targetPort</a></div>
      </td>
      <td>int</td>
  ...
  <tbody>
    <tr>
      <td id="sygnal--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L867">sygnal.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="sygnal--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L869">sygnal.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v0.12.0"
    ...
    <tr>
      <td id="sygnal--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L881">sygnal.podSecurityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="sygnal--proxy">
        <div style="max-width: 150px;"><a href="../values.yaml#L886">sygnal.proxy</a></div>
      </td>
      <td>string</td>
...
{}
    ...
    <tr>
      <td id="sygnal--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L895">sygnal.securityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="sygnal--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L902">sygnal.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"150m"
    ...
    <tr>
      <td id="sygnal--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L904">sygnal.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"45Mi"
    ...
    <tr>
      <td id="sygnal--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L907">sygnal.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"150m"
    ...
    <tr>
      <td id="sygnal--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L909">sygnal.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"45Mi"
    ...
    <tr>
      <td id="sygnal--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L915">sygnal.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Pfad des Healthchecks</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="sygnal--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L917">sygnal.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Port des Healthchecks</td>
      <td>
...
"http"
    ...
    <tr>
      <td id="sygnal--readinessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L923">sygnal.readinessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Pfads vom Bereitschaftscheck</td>
      <td>
...
"/health"
    ...
    <tr>
      <td id="sygnal--readinessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L925">sygnal.readinessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Ports vom Bereitschaftscheck</td>
      <td>
...
"http"
    ...
    <tr>
      <td id="sygnal--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L928">sygnal.nodeSelector</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="sygnal--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L931">sygnal.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="sygnal--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L934">sygnal.affinity</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="sygnal--apns">
        <div style="max-width: 150px;"><a href="../values.yaml#L942">sygnal.apns</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="sygnal--ios_push--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L947">sygnal.ios_push.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="sygnal--ios_push--ioskey_filename">
        <div style="max-width: 150px;"><a href="../values.yaml#L954">sygnal.ios_push.ioskey_filename</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="sygnal--ios_push--ioskey_keyvalue">
        <div style="max-width: 150px;"><a href="../values.yaml#L955">sygnal.ios_push.ioskey_keyvalue</a></div>
      </td>
      <td>object</td>
      <td></td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="wellknown--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L967">wellknown.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="wellknown--server">
        <div style="max-width: 150px;"><a href="../values.yaml#L972">wellknown.server</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="wellknown--client">
        <div style="max-width: 150px;"><a href="../values.yaml#L982">wellknown.client</a></div>
      </td>
      <td>map</td>
      <td>Daten, die auf .well-known/matrix/client bereitgestellt werden sollen Beispiel:    io.element.e2ee:    secure_backup_required: true    secure_backup_setup_methods: ["passphrase"]    outbound_keys_pre_sharing_mode: "on_room_opening"  m.homeserver:    base_url: https://matrix.example.com</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
{}
</pre>
    ...
    <tr>
      <td id="wellknown--extraData">
        <div style="max-width: 150px;"><a href="../values.yaml#L993">wellknown.extraData</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="wellknown--htdocsPath">
        <div style="max-width: 150px;"><a href="../values.yaml#L997">wellknown.htdocsPath</a></div>
      </td>
      <td>path</td>
...
"/usr/share/nginx/html"
    ...
    <tr>
      <td id="wellknown--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1003">wellknown.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "1.18.0-6ubuntu14.2"
    ...
    <tr>
      <td id="wellknown--podSecurityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1014">wellknown.podSecurityContext</a></div>
      </td>
      <td>map</td>
      <td>Informationen zum Sicherheitskontext, die dem Arbeiter mitgeteilt werden sollen. weitere Möglichkeiten:  fsGroup: 2001  runAsGroup: 2001  runAsUser: 2001</td>
      <td>
        <div style="max-width: 300px;"><pre lang="json">
{}
</pre>
    ...
    <tr>
      <td id="wellknown--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1021">wellknown.securityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="wellknown--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1029">wellknown.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="wellknown--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1031">wellknown.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"15Mi"
    ...
    <tr>
      <td id="wellknown--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1034">wellknown.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="wellknown--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1036">wellknown.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="wellknown--nodeSelector">
        <div style="max-width: 150px;"><a href="../values.yaml#L1039">wellknown.nodeSelector</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="wellknown--tolerations">
        <div style="max-width: 150px;"><a href="../values.yaml#L1042">wellknown.tolerations</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="wellknown--affinity">
        <div style="max-width: 150px;"><a href="../values.yaml#L1045">wellknown.affinity</a></div>
      </td>
      <td>list</td>
  ...
  <tbody>
    <tr>
      <td id="postgresql--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1059">postgresql.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="postgresql--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1065">postgresql.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": 14
    ...
    <tr>
      <td id="postgresql--postgresqlDatabase">
        <div style="max-width: 150px;"><a href="../values.yaml#L1072">postgresql.postgresqlDatabase</a></div>
      </td>
      <td>string</td>
...
"synapse_db"
    ...
    <tr>
      <td id="postgresql--postgresqlPassword">
        <div style="max-width: 150px;"><a href="../values.yaml#L1080">postgresql.postgresqlPassword</a></div>
      </td>
      <td>string</td>
...
"synapse"
    ...
    <tr>
      <td id="postgresql--postgresqlUsername">
        <div style="max-width: 150px;"><a href="../values.yaml#L1083">postgresql.postgresqlUsername</a></div>
      </td>
      <td>string</td>
...
"synapse"
    ...
    <tr>
      <td id="postgresql--postgresqlInitdbArgs">
        <div style="max-width: 150px;"><a href="../values.yaml#L1086">postgresql.postgresqlInitdbArgs</a></div>
      </td>
      <td>string</td>
...
"--lc-collate=C --lc-ctype=C"
    ...
    <tr>
      <td id="postgresql--persistence">
        <div style="max-width: 150px;"><a href="../values.yaml#L1089">postgresql.persistence</a></div>
      </td>
      <td>map</td>
  ...
  "storageClass": ""
    ...
    <tr>
      <td id="postgresql--extraArgs">
        <div style="max-width: 150px;"><a href="../values.yaml#L1095">postgresql.extraArgs</a></div>
      </td>
      <td>list</td>
...
{}
    ...
    <tr>
      <td id="externalPostgresql">
        <div style="max-width: 150px;"><a href="../values.yaml#L1100">externalPostgresql</a></div>
      </td>
      <td>map</td>
  ...
  "username": "synapse"
    ...
    <tr>
      <td id="externalPostgresql--existingSecret">
        <div style="max-width: 150px;"><a href="../values.yaml#L1107">externalPostgresql.existingSecret</a></div>
      </td>
      <td>string</td>
...
"postgres-secrets"
    ...
    <tr>
      <td id="externalPostgresql--existingSecretPasswordKey">
        <div style="max-width: 150px;"><a href="../values.yaml#L1110">externalPostgresql.existingSecretPasswordKey</a></div>
      </td>
      <td>string</td>
...
"POSTGRES_PASSWORD"
    ...
    <tr>
      <td id="externalPostgresql--database">
        <div style="max-width: 150px;"><a href="../values.yaml#L1113">externalPostgresql.database</a></div>
      </td>
      <td>string</td>
...
"synapse_db"
    ...
    <tr>
      <td id="externalPostgresql--extraArgs">
        <div style="max-width: 150px;"><a href="../values.yaml#L1119">externalPostgresql.extraArgs</a></div>
      </td>
      <td>list</td>
      <td>Zusätzliche Argumente für die Datenbankverbindung ref: https://github.com/matrix-org/synapse/blob/develop/docs/postgres.md#synapse-config</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="redis--image--registry">
        <div style="max-width: 150px;"><a href="../values.yaml#L1131">redis.image.registry</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"registry.opencode.de"
    ...
    <tr>
      <td id="redis--image--repository">
        <div style="max-width: 150px;"><a href="../values.yaml#L1132">redis.image.repository</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"bwi/bundesmessenger/backend/container-images/jammy-redis-production"
    ...
    <tr>
      <td id="redis--image--tag">
        <div style="max-width: 150px;"><a href="../values.yaml#L1133">redis.image.tag</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"5_6.0.16-1ubuntu1"
    ...
    <tr>
      <td id="redis--image--pullSecrets[0]">
        <div style="max-width: 150px;"><a href="../values.yaml#L1134">redis.image.pullSecrets[0]</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"myRegistryKeySecretName"
    ...
    <tr>
      <td id="redis--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1138">redis.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="redis--auth">
        <div style="max-width: 150px;"><a href="../values.yaml#L1145">redis.auth</a></div>
      </td>
      <td>map</td>
  ...
  "password": "synapse"
    ...
    <tr>
      <td id="redis--architecture">
        <div style="max-width: 150px;"><a href="../values.yaml#L1150">redis.architecture</a></div>
      </td>
      <td>string</td>
...
"standalone"
    ...
    <tr>
      <td id="redis--master--persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1156">redis.master.persistence.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="redis--master--service--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1159">redis.master.service.port</a></div>
      </td>
      <td>int</td>
      <td>Serviceport</td>
      <td>
...
6379
    ...
    <tr>
      <td id="redis--master--statefulset--updateStrategy">
        <div style="max-width: 150px;"><a href="../values.yaml#L1163">redis.master.statefulset.updateStrategy</a></div>
      </td>
      <td>string</td>
...
"RollingUpdate"
    ...
    <tr>
      <td id="externalRedis">
        <div style="max-width: 150px;"><a href="../values.yaml#L1172">externalRedis</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="ingress--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1188">ingress.enabled</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--traefikPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1192">ingress.traefikPaths</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/use-regex"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1198">ingress.annotations."nginx.ingress.kubernetes.io/use-regex"</a></div>
      </td>
      <td>bool</td>
...
"true"
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/proxy-body-size"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1200">ingress.annotations."nginx.ingress.kubernetes.io/proxy-body-size"</a></div>
      </td>
      <td>string</td>
...
"50m"
    ...
    <tr>
      <td id="ingress--annotations--"nginx--ingress--kubernetes--io/enable-owasp-core-rules"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1201">ingress.annotations."nginx.ingress.kubernetes.io/enable-owasp-core-rules"</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"true"
    ...
    <tr>
      <td id="ingress--csHosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1210">ingress.csHosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--hosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1217">ingress.hosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--wkHosts">
        <div style="max-width: 150px;"><a href="../values.yaml#L1224">ingress.wkHosts</a></div>
      </td>
      <td>list</td>
...
[]
    ...
    <tr>
      <td id="ingress--paths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1241">ingress.paths</a></div>
      </td>
      <td>path</td>
...
[]
    ...
    <tr>
      <td id="ingress--csPaths">
        <div style="max-width: 150px;"><a href="../values.yaml#L1258">ingress.csPaths</a></div>
      </td>
      <td>path</td>
...
[]
    ...
    <tr>
      <td id="ingress--includeUnderscoreSynapse">
        <div style="max-width: 150px;"><a href="../values.yaml#L1261">ingress.includeUnderscoreSynapse</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--includeServerName">
        <div style="max-width: 150px;"><a href="../values.yaml#L1265">ingress.includeServerName</a></div>
      </td>
      <td>bool</td>
...
true
    ...
    <tr>
      <td id="ingress--tls">
        <div style="max-width: 150px;"><a href="../values.yaml#L1277">ingress.tls</a></div>
      </td>
      <td>map</td>
...
[]
    ...
    <tr>
      <td id="ingress--className">
        <div style="max-width: 150px;"><a href="../values.yaml#L1282">ingress.className</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="contentscanner--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1290">contentscanner.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="contentscanner--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1292">contentscanner.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "1.0.3"
    ...
    <tr>
      <td id="contentscanner--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L1297">contentscanner.replicaCount</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
1
    ...
    <tr>
      <td id="contentscanner--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1301">contentscanner.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"500m"
    ...
    <tr>
      <td id="contentscanner--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1303">contentscanner.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"1Gi"
    ...
    <tr>
      <td id="contentscanner--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1306">contentscanner.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="contentscanner--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1308">contentscanner.resources.requests.memory</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="schadcodescanner--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1316">schadcodescanner.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="schadcodescanner--imageclamav">
        <div style="max-width: 150px;"><a href="../values.yaml#L1318">schadcodescanner.imageclamav</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "0.103.6_dfsg-0ubuntu0.22.04.1"
    ...
    <tr>
      <td id="schadcodescanner--imagecicap">
        <div style="max-width: 150px;"><a href="../values.yaml#L1323">schadcodescanner.imagecicap</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "1_0.5.6-2build1"
    ...
    <tr>
      <td id="schadcodescanner--persistence--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1330">schadcodescanner.persistence.enabled</a></div>
      </td>
      <td>bool</td>
      <td></td>
      <td>
...
true
    ...
    <tr>
      <td id="schadcodescanner--persistence--existingClaim">
        <div style="max-width: 150px;"><a href="../values.yaml#L1333">schadcodescanner.persistence.existingClaim</a></div>
      </td>
      <td>string</td>
      <td>Name des VolumeClaims</td>
      <td>
...
leer, damit dynamische Volumes genutzt werden können (dennoch persistent)
    ...
    <tr>
      <td id="schadcodescanner--persistence--storageClass">
        <div style="max-width: 150px;"><a href="../values.yaml#L1335">schadcodescanner.persistence.storageClass</a></div>
      </td>
      <td>string</td>
...
""
    ...
    <tr>
      <td id="schadcodescanner--persistence--accessMode">
        <div style="max-width: 150px;"><a href="../values.yaml#L1337">schadcodescanner.persistence.accessMode</a></div>
      </td>
      <td>string</td>
...
"ReadWriteOnce"
    ...
    <tr>
      <td id="schadcodescanner--persistence--size">
        <div style="max-width: 150px;"><a href="../values.yaml#L1339">schadcodescanner.persistence.size</a></div>
      </td>
      <td>string</td>
      <td>Größe des zu nutzenden Volumes</td>
      <td>
...
"10Gi"
    ...
    <tr>
      <td id="schadcodescanner--service--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1342">schadcodescanner.service.port</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
3310
    ...
    <tr>
      <td id="schadcodescanner--freshclam--mirrors">
        <div style="max-width: 150px;"><a href="../values.yaml#L1345">schadcodescanner.freshclam.mirrors</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
...
"database.clamav.net"
    ...
    <tr>
      <td id="schadcodescanner--replicaCount">
        <div style="max-width: 150px;"><a href="../values.yaml#L1350">schadcodescanner.replicaCount</a></div>
      </td>
      <td>int</td>
      <td>Anzahl der Worker-Container Hinweis: Wenn autoscaling.enabled=true und replicaCount geringer als autoscaling.minReplicas oder wenn nicht gesetzt, dann wird autoscaling.minReplicas übernommen</td>
      <td>
...
1
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1357">schadcodescanner.autoscaling.enabled</a></div>
      </td>
      <td>bool</td>
      <td>schalte das HPA für die Container ein Hinweis: Kann für alle spezifischen Worker benutzt werden Dazu muss entsprechende Konfiguration in die separaten Sektionen eingefügt werden</td>
      <td>
...
false
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--minReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L1359">schadcodescanner.autoscaling.minReplicas</a></div>
      </td>
      <td>int</td>
      <td>minimale Anzahl der Worker-Container</td>
      <td>
...
1
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--maxReplicas">
        <div style="max-width: 150px;"><a href="../values.yaml#L1361">schadcodescanner.autoscaling.maxReplicas</a></div>
      </td>
      <td>int</td>
      <td>maximale Anzahl der Worker-Container</td>
      <td>
...
4
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--targetCPUUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L1363">schadcodescanner.autoscaling.targetCPUUtilizationPercentage</a></div>
      </td>
      <td>int</td>
      <td>Prozentsatz für CPU-Auslastung um Scaling zu triggern</td>
      <td>
...
90
    ...
    <tr>
      <td id="schadcodescanner--autoscaling--targetMemoryUtilizationPercentage">
        <div style="max-width: 150px;"><a href="../values.yaml#L1365">schadcodescanner.autoscaling.targetMemoryUtilizationPercentage</a></div>
      </td>
      <td>int</td>
      <td>Prozentsatz für RAM-Auslastung um Scaling zu triggern</td>
      <td>
...
80
    ...
    <tr>
      <td id="schadcodescanner--limits--fileSize">
        <div style="max-width: 150px;"><a href="../values.yaml#L1369">schadcodescanner.limits.fileSize</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
20
    ...
    <tr>
      <td id="schadcodescanner--limits--scanSize">
        <div style="max-width: 150px;"><a href="../values.yaml#L1371">schadcodescanner.limits.scanSize</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
100
    ...
    <tr>
      <td id="schadcodescanner--limits--connectionQueueLength">
        <div style="max-width: 150px;"><a href="../values.yaml#L1373">schadcodescanner.limits.connectionQueueLength</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
100
    ...
    <tr>
      <td id="schadcodescanner--limits--maxThreads">
        <div style="max-width: 150px;"><a href="../values.yaml#L1375">schadcodescanner.limits.maxThreads</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
4
    ...
    <tr>
      <td id="schadcodescanner--limits--sendBufTimeout">
        <div style="max-width: 150px;"><a href="../values.yaml#L1377">schadcodescanner.limits.sendBufTimeout</a></div>
      </td>
      <td>int</td>
      <td></td>
      <td>
...
500
    ...
    <tr>
      <td id="schadcodescanner--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1382">schadcodescanner.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"1500m"
    ...
    <tr>
      <td id="schadcodescanner--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1384">schadcodescanner.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"3Gi"
    ...
    <tr>
      <td id="schadcodescanner--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1387">schadcodescanner.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"300m"
    ...
    <tr>
      <td id="schadcodescanner--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1389">schadcodescanner.resources.requests.memory</a></div>
      </td>
      <td>string</td>
  ...
  <tbody>
    <tr>
      <td id="coturn--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1403">coturn.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="coturn--turnUris">
        <div style="max-width: 150px;"><a href="../values.yaml#L1406">coturn.turnUris</a></div>
      </td>
      <td>map</td>
  ...
  "udp": 3478
    ...
    <tr>
      <td id="coturn--existingcoturn--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1412">coturn.existingcoturn.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="coturn--default_ns">
        <div style="max-width: 150px;"><a href="../values.yaml#L1414">coturn.default_ns</a></div>
      </td>
      <td>string</td>
...
"default"
    ...
    <tr>
      <td id="coturn--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1416">coturn.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "Hier das Tag für das Image des Coturn eintragen - NICHT EMPFOHLEN!"
    ...
    <tr>
      <td id="coturn--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1421">coturn.securityContext</a></div>
      </td>
      <td>map</td>
  ...
  <tbody>
    <tr>
      <td id="synapse_admin--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1434">synapse_admin.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="synapse_admin--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L1436">synapse_admin.uri</a></div>
      </td>
      <td>string</td>
...
null
    ...
    <tr>
      <td id="synapse_admin--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1438">synapse_admin.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "0.8.5"
    ...
    <tr>
      <td id="synapse_admin--resources--limits--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1447">synapse_admin.resources.limits.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="synapse_admin--resources--limits--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1449">synapse_admin.resources.limits.memory</a></div>
      </td>
      <td>object</td>
...
"15Mi"
    ...
    <tr>
      <td id="synapse_admin--resources--requests--cpu">
        <div style="max-width: 150px;"><a href="../values.yaml#L1452">synapse_admin.resources.requests.cpu</a></div>
      </td>
      <td>string</td>
...
"5m"
    ...
    <tr>
      <td id="synapse_admin--resources--requests--memory">
        <div style="max-width: 150px;"><a href="../values.yaml#L1454">synapse_admin.resources.requests.memory</a></div>
      </td>
      <td>string</td>
...
"15Mi"
    ...
    <tr>
      <td id="synapse_admin--podSecurityContext--sysctls">
        <div style="max-width: 150px;"><a href="../values.yaml#L1461">synapse_admin.podSecurityContext.sysctls</a></div>
      </td>
      <td>map</td>
...
[
  {
    ...
    <tr>
      <td id="synapse_admin--securityContext">
        <div style="max-width: 150px;"><a href="../values.yaml#L1469">synapse_admin.securityContext</a></div>
      </td>
      <td>map</td>
...
{}
    ...
    <tr>
      <td id="synapse_admin--livenessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L1500">synapse_admin.livenessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Pfad des Healthchecks</td>
      <td>
...
"/"
    ...
    <tr>
      <td id="synapse_admin--livenessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1502">synapse_admin.livenessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Zu verwendende Konfiguration für den Port des Healthchecks</td>
      <td>
...
"http"
    ...
    <tr>
      <td id="synapse_admin--readinessProbe--httpGet--path">
        <div style="max-width: 150px;"><a href="../values.yaml#L1508">synapse_admin.readinessProbe.httpGet.path</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Pfads vom Bereitschaftscheck</td>
      <td>
...
"/"
    ...
    <tr>
      <td id="synapse_admin--readinessProbe--httpGet--port">
        <div style="max-width: 150px;"><a href="../values.yaml#L1510">synapse_admin.readinessProbe.httpGet.port</a></div>
      </td>
      <td>string</td>
      <td>Konfiguration des Ports vom Bereitschaftscheck</td>
      <td>
  ...
  <tbody>
    <tr>
      <td id="webclient--enabled">
        <div style="max-width: 150px;"><a href="../values.yaml#L1519">webclient.enabled</a></div>
      </td>
      <td>bool</td>
...
false
    ...
    <tr>
      <td id="webclient--uri">
        <div style="max-width: 150px;"><a href="../values.yaml#L1521">webclient.uri</a></div>
      </td>
      <td>string</td>
...
null
    ...
    <tr>
      <td id="webclient--image">
        <div style="max-width: 150px;"><a href="../values.yaml#L1523">webclient.image</a></div>
      </td>
      <td>map</td>
  ...
  "tag": "v1.26.0"
    ...
    <tr>
      <td id="webclient--annotations--"nginx--ingress--kubernetes--io/configuration-snippet"">
        <div style="max-width: 150px;"><a href="../values.yaml#L1528">webclient.annotations."nginx.ingress.kubernetes.io/configuration-snippet"</a></div>
      </td>
      <td>string</td>
      <td></td>
      <td>
