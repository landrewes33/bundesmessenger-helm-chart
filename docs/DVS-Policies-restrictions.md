...
| require-run-as-non-root | **FIXED:** Anpassung securityContext und podSecurityContext <br /> **TODO: SYGNAL** listen auf Port 80 als Nodejs :( Kernel 4.4 oder älter zwingend notwendig auf WorkerNodes! |
