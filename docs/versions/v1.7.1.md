# Abhängigkeiten BundesMessenger Helm Chart 1.7.1 (2024-04-23)
...
| Webclient | registry.opencode.de/bwi/bundesmessenger/backend/container-images/bundesmessenger-web | 2.16.0-jammy-production |
...
| Synapse | registry.opencode.de/bwi/bundesmessenger/backend/container-images/synapse | 1.103.0-jammy-production |
| Kubectl | registry.opencode.de/bwi/bundesmessenger/backend/container-images/kubectl | 1.29.3-jammy-production |
...
| Sygnal | registry.opencode.de/bwi/bundesmessenger/backend/container-images/sygnal | 0.14.1-jammy-production |
| Synapse-Admin | registry.opencode.de/bwi/bundesmessenger/backend/container-images/synapse-admin | 0.9.1-jammy-production |
| Matrix-Authentication-Service | ghcr.io/matrix-org/matrix-authentication-service | 0.8-debug |
